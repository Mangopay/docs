...
For more information or to activate contact the Support team [via the Hub](https://hub.mangopay.com/).  
</Note>  
...
<CardGroup cols={2}>
    <Card title="Endpoint" href="/api-reference/conversion-rates/view-conversion-rate">View an indicative Conversion Rate</Card>  

    <Card title="Endpoint" href="/api-reference/quotes/quote-object">The Quote object</Card>  

    <Card title="Endpoint" href="/api-reference/conversions/conversion-object">The Conversion object</Card>
</CardGroup>