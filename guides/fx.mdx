...
Mangopay relies on a dedicated transaction type, conversion, to convert funds between wallets of different currencies.

Conversions allow you to provide FX services to your users by converting funds between their wallets. 

The same conversion transaction can be used by your platform to convert funds between your Fees Wallets and Repudiation Wallets.
...
**2. Execute the conversion against the quote**
...
The [View a Conversion](/api-reference/conversions/view-conversion) endpoint returns both instant and quoted conversions between user and client wallets. 
...
- [List Transactions for a Client Wallet](/api-reference/transactions/list-transactions-client-wallet)  
