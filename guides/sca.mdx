...
SCA is applicable to all the [SCA-triggering actions](#actions-requiring-sca) that the `OWNER` user takes, whether via the API or via the Dashboard. Initially, your platform needs to change its API implementation. 
