...
The full string must be less than 64 characters, meaning that there are 28 characters available for the `ClientId`. If your Sandbox or Production `ClientId` is longer than 28 characters, you need to truncate it.
</Warning>  
