...
<td>
A process error occurred in the case of a refund cancellation. For example, a user requested a refund and it was not processed correctly. This reason may only be used for cases where a charge was made via the refund cancellation service.
</td>
</tr>
<tr>
<td>
