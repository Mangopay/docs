...
Prior to processing recurring payments, you need to have a card registered. For more information regarding the card registration, see the <a href="/guides/payment-methods/card/how-to">How to process a card payment</a> article.
