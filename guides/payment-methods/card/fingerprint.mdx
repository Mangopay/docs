...
<CardGroup col={2}>
    <Card title="Endpoint" href="/api-reference/">List Cards for a Fingerprint</Card>

    <Card title="Endpoint" href="/api-reference/">List Users for a Card Fingerprint</Card>

    <Card title="Endpoint" href="/api-reference/">List Transactions for a card fingerprint</Card>
</CardGroup>
