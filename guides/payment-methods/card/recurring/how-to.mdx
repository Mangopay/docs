...
For more information on how to handle 3DS redirection, see Steps 6 and 7 of the <a href="/guides/payment-methods/card/how-to">How to process a card payment</a> guide.  
