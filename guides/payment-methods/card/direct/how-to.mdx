...
```json REST
{
    ...
    "data": "S2mSVl8PLRVHgaMNATInMmVYAECTzrAc5dfWTT8a8IIJiWHX6X35gAS9zfOm2DJa2ddFLVXdicolcUIkv_kKEA",
...
In response, the API returns the `CardId` indicating that the card is registered successfully.
...
```  
You'll need the `CardId` in the next step to request the payment.
