...
For an overview of the data flows, see the <a href="/guide/payment-methods/google-pay">Google Pay</a> guide. To integrate [Google Pay](/guides/payment-methods/google-pay) on your side, see the [Google Pay documentation](https://developers.google.com/pay/api).  
