...
<CardGroup col={2}> 
    <Card title="Endpoint" href="/api-reference/mb-way/mb-way-payin-object">The MB WAY PayIn object</Card>  

    <Card title="Testing" href="/testing/payment-methods#mb-way-pay">Learn about testing MB WAY</Card>
</CardGroup>