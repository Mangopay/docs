...
<Steps>
    ...
    <Step title="Add the tracking number and carrier using the Add tracking information to a PayPal PayIn endpoint">
    ...
    <Step title="Optionally, trigger an email from PayPal to the buyer by setting `NotifyBuyer` to `true`">
...
<CardGroup col={2}> 
    <Card title="Endpoint" href="/api-reference/paypal/paypal-payin-object">The PayPal PayIn object</Card>  

    <Card title="Testing" href="/testing/payment-methods#paypal">Learn about testing PayPal</Card>
</CardGroup> 