...
The [Supported banks and schemes](/guides/payment-methods/banking/pay-by-bank/supported-banks) page lists the `BankName` values available per `Country`, the `Scheme` values supported per bank, and the default value.
...
<Card title="Supported banks and schemes" href="/guides/payment-methods/banking/pay-by-bank/supported-banks">
See the list of supported schemes per bank
</Card>
