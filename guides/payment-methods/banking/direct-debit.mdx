...
To avoid conflicts between a refund and late failure, we strongly recommend waiting at least 8 business days following a successful transaction before processing a refund.
</Warning>  
