...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td rowSpan="3" class="rowSpan table-content">`CB_VISA_MASTERCARD`</td>
            <td rowSpan="3" class="rowSpan table-content">AED, AUD, CAD, CHF, DKK, EUR, GBP, HKD, JPY, NOK, PLN, SEK</td>
        </tr>
        <tr>
