...
Once Recipients is fully live in May 2025, the legacy Bank Account endpoints will be deprecated with a planned decommission in 2026. Existing bank accounts will be compatible with the new Recipients feature. This means: 
- that your platform will be able to continue using the `BankAccountId` of **active** bank accounts for payouts.
