...
The user must complete [SCA](/guides/users/sca) to register their bank account. This means you need to redirect them to the Mangopay-hosted SCA session. For more details on this process, see the [SCA session](/guides/sca/session) guide.
