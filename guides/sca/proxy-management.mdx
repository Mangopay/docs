...
The use of proxy and consent to act on a user’s behalf also requires SCA on your platform directly. Mangopay is implementing that by way of a new authentication factor, an mTLS certificate, in addition to your existing API key.
