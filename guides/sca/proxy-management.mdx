...
<Note>
**Note – Acting under proxy will require additional platform authentication** 

The use of proxy and consent to act on a user’s behalf will also require SCA on your platform directly. Mangopay is implementing that by way of a new authentication factor, an mTLS certificate, in addition to your existing API key.
