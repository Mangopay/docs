...
On the 4 endpoints listed above (only), Mangopay has introduced a **new query parameter**, `ScaContext`, which your platform needs to send on all requests initiated by Owners.
