...
If SCA is required for the transfer request, the API response will contain `PendingUserAction.RedirectUrl` and the individual must authenticate on the Mangopay-hosted webpage.
