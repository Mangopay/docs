...
SCA will be applied when the user takes an action requiring SCA. For more details, see [existing user integration](/guides/sca/users#existing-user-integration).
