...
You should enroll your active Owner users when they interact with your platform, which you can do using the [POST Enroll a User](/api-reference/users/enroll-user) endpoint. We recommend setting up regular email notifications or in-app messages inviting your active users to enroll.
