...
<Note>
**Note – Legal representative's email required**
...
Prior to SCA, it was possible to create a Legal `OWNER` without the `LegalRepresentativeEmail`. So you may need to obtain this data for your existing legal users to enroll them in SCA.
</Note>
