...
flowchart LR
    n6["Offer passkey <br>factor"] ==> n7(["User enrolls <br>passkey?"])
    n8["User confirms <br>email"] ==> n11["User enrolls <br>PIN"]
    n11 ==> n13(["END"])
    n14(["START"]) ==> n4(["Device supports <br>WebAuth?"])
    n12["User confirms <br>email"] ==> n15["User enrolls <br>PIN"]
    n15 ==> n16["User enrolls <br>OTP SMS"]
    n16 ==> n13
    n4 ==  No  ===> n8 
    n4 ==  Yes  ===> n6
    n7 ==  No  ===> n8 
