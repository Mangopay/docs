...
The hosted SCA page is automatically set to the language of the user's browser if it is one of the following supported languages: Dutch, English, French, German, Italian, Polish, Portuguese, Spanish.

{/* Add Greek on release, remove Sep 29 date */}
...
You can override this and manually set the language for the session before you redirect the user – [read more](/guides/sca/session#4-set-the-session-language-optional) (available week of Sep 29, 2025).
