...
<img height="512" src="/images/screenshot_sca_welcome_auth.png" />
...
Below is an example of the process using MacOS, a passkey stored in a Google Chrome profile, and the laptop password.
