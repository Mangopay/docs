...
<Tabs>
<Tab title="Users">
For example, in the API response for user endpoints:
...
<Tab title="Recipients">
For example, in the API response for recipient creation:
...
<Tab title="Transfers">
For example, in the API response for transfer initiation:
