...
SCA will be applied when the user takes an action requiring SCA. This situation only applies to existing users – for new users they must enroll when their account is created.
