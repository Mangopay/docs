...
<Card title="PUT Edit a Natural User (SCA)" href="/api-reference/users/update-natural-user-sca">
...
<Card title="PUT Edit a Legal User (SCA)" href="/api-reference/users/update-legal-user-sca">
...
<Steps>
<Step title="Provide identity data via API"s>
