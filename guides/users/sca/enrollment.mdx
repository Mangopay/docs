...
<Card title="POST Create a Natural User (SCA)">
Register a Natural Payer or Owner
</Card>
<Card title="PUT Edit a Natural User (SCA)">
Modify details for a Natural Payer or Owner
</Card>
<Card title="POST Create a Legal User (SCA)">
Register a Legal Payer or Owner
</Card>
<Card title="PUT Edit a Legal User (SCA)">
...
<Card title="Register a Natural Payer or Owner">
Register a Natural Payer or Owner
</Card>
...
<Card title="PUT Categorize a Natural User as Owner (SCA)">
Transition a Natural Payer to Owner
</Card>
<Card title="PUT Categorize a Legal User as Owner (SCA)">
