...
<img className="block dark:hidden" src="/images/diagram_sca_redirection_light.svg" />
<img className="hidden dark:block" src="/images/diagram_sca_redirection_dark.svg" />
