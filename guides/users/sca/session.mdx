...
<img className="block dark:hidden" src="/images/diagram_sca_session_light.svg" width="100%"/>
<img className="hidden dark:block" src="/images/diagram_sca_session_dark.svg" width="100%"/>
