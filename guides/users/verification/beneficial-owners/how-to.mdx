...
You can simulate the acceptance or refusal of a UBO Declaration in Sandbox. To do so, when you create the first UBO (Step 2 below), set the `FirstName` to the relevant value to produce the desired outcome after submission (Step 4):
