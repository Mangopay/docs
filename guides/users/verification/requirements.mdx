...
This page outlines the requirements that a user needs to fulfill to be verified, which means their `KYCLevel` becomes `REGULAR`.
...
The informaiton declared in the User object of the API must match the documents and other evidence provided. 
...
<tbody>
  ...
  <tr>
    ...
    <td class="table-content">{IconGreenCheck}</td>
    <td class="table-content">**Required** – see <a href="/guides/users/verification/requirements/beneficial-owners">beneficial owners</a></td>
  </tr>
  <tr>
...
Soletrader users should declare themselves as their legal representative. Their registerd name and address must be in the `Name` and `HeadquartersAddress` parameters, with their personal details in the legal representative parameters.
