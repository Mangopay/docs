...
<td class="table-content">Submit the requested supporting document as a KYC Document of the `SHAREHOLDER_DECLARATION` type. Check the `Message` parameter for more details.</td>
</tr>
<tr>
