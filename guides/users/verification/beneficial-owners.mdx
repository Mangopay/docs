...
<Card title="How to" href="/guides/users/verification/beneficial-owners/how-to">Learn how to submit a UBO Declaration</Card>  
...
<td class="table-content">One or more beneficial owners are missing from the declaration. For example, in the verification documents 2 individuals are indicated as owning more than 25%, but only one appears as a UBO in the UBO Declaration object.</td>
...
See the [glossary](concepts/glossary) for more information about who is considered a beneficial owner.
</td>
</tr>
<tr>
