...
If the user changes the `LegalRepresentativeFirstName`, `LegalRepresentativeLastName`, `LegalRepresentativeBirthday`, or `LegalRepresentativeNationality`, then they will be [downgraded](#downgrade) at this stage.
</Step>
