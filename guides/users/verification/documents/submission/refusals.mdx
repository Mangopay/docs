...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      The following are some examples of issues that may lead to this result: low image resolution, glare, shadows, blurriness, modified contrast, document cutoff by the edge of the image frame, document that is heavily slanted and not aligned with the image frame, etc.
      </td>
