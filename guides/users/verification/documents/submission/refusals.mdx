    ...
    <tbody>
        <tr>
            ...
            <td class="table-content">
                The document is suspected to be fraudulent. This flag results in the user being [blocked](/guides/users/blocked-users.mdx). 

                To unblock their account, the user needs to submit a different kind of identity proof document. For example, if a national ID card was marked as fraudulent, they need to submit a passport.
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="table-content">
                ...
                Please contact the Support team <a href="https://hub.mangopay.com/" target="_blank">via the Hub</a> if you require further details.
            </td>
        </tr>
    </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="table-content">
      On an identity proof, this reason type results in the user being [blocked](/guides/users/blocked-users.mdx). 
