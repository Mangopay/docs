...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      The following are some examples of issues that may lead to this result: low image resolution, glare, shadows, blurriness, modified contrast, document cut off by the edge of the image frame, document heavily slanted and not aligned with the image frame, etc.
      </td>
