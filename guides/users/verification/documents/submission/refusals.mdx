...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td class="table-content">`DOCUMENT_NOT_ACCEPTED`</td>
      <td class="table-content">The document is not accepted; it doesn't fit the verification requirements outlined by us.</td>
      <td class="table-content">Check that the Shareholder Declaration form is part of the [requirements](/guides/users/verification/requirements/kyb-local) for the user and that the [latest version](/guides/users/verification/documents/types) has been submitted.</td>
    </tr>
    <tr>
      <td class="table-content">`DOCUMENT_DO_NOT_MATCH_USER_DATA`</td>
