...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td class="table-content">`DOCUMENT_FALSIFIED`</td>
      <td class="table-content">The document seems to be fraudulent or contains inconsistent information.</td>
      <td class="table-content">Check that the document provided matches the [requirements](/guides/users/verification/requirements/kyb-local) and has not been altered by any means.</td>
    </tr>
    <tr>
      <td class="table-content">`SPECIFIC_CASE`</td>
