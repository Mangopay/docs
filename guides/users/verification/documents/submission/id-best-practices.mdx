...
<Card title="How to" href="/how-to/submit-kyc-document">Submit a KYC Document for verification</Card>
...
<CardGroup cols={2}>
    ...
    <Card title="Guide" href="/guides/users/verification/requirements">Learn about verification requirements</Card>

   <Card title="How to" href="/how-to/submit-kyc-document">Learn how to submit a KYC Document</Card>
</CardGroup>
