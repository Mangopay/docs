...
### Do legal users need to provide a UBO Declaration as part of their identity verification?
Users only need to provide an updated UBO Declaration regarding your beneficial owners if the ownership shareholding structure has changed since the previous identity verification.

### Do legal users need to provide a Shareholder Declaration as part of their identity verification?
Yes, if a Shareholder Declaration is required, users need to provide a new one.