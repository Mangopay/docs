...
The accepted identity proof documents depend on the issuing country of the document. You can find guidelines on which documents we accept in the <a href="/guides/users/verification/requirements/id-accepted" target="_blank">proof of identity</a> article.