...
<td class="table-content">
The conditions surrounding transfers are still being defined. Mangopay is developing its Transfers functionality to allow for technical or automated transfers as part of specific workflows. For other transfers, platforms may be able to benefit from exemptions allowed by the regulations (such as low-risk or low-amount transactions).
</td>
</tr>
<tr>
<td class="table-content">
...
<td class="table-content">
The conditions surrounding wallet access are still being defined. SCA is applicable on first-time access and if more than 180 days have passed since the last wallet consultation event.
</td>
</tr>
<tr>
<td class="table-content">
...
<td class="table-content">
The conditions surrounding transaction history are still being defined. SCA is applicable on first-time access, and if more than 180 days have passed since the last wallet consultation event (provided the transactions are not older than 90 days).
</td>
</tr>
</tbody>
</table>
