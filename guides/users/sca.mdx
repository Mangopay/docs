...
<td>
The conditions surrounding transfers are still being defined. Mangopay is developing its Transfers functionality to allow for technical or automated transfers as part of specific workflows. For other transfers, platforms will be able to benefit from exemptions such as low-risk or low-amount transactions (less than €30).
</td>
</tr>
<tr>
<td class="table-content">
