...
<td class="table-content">
When an Owner user is registered with Mangopay, they must provide and authenticate (enroll) their phone number. This applies to:
- First-time registration as an Owner
- Transition from the Payer category
