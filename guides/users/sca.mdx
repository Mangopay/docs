...
In Sandbox, you can test the SMS OTP by sending a real phone number in the user object. 

Alternatively, you can use `+33611111111` (or `0611111111` and `FR`) and the passcode **702100** to simulate a successful flow.

<Note>
**Note – LastName must finish "Review"**

To trigger SCA, you need ensure the `LastName` (or `LegalRepresentative.LastName`) value finishes with the word “Review”, as shown below.
</Note>
