...
In the API response from an endpoint triggering an [SCA scenario](/guides/users/sca/enrollment#owners), the `PendingUserAction` object contains a `RedirectURL` value. For example:
...
...
	...
	"PendingUserAction": {
		"RedirectURL": "https://sca.mangopay.com?sessionId=sca_s_01J7NV9TTVGXSFH2MKRG98N6NC"
    },
...
}
```
...
- https<span>://</span>sca.mangopay.com?sessionId=sca_s_01J7NV9TTVGXSFH2MKRG98N6NC
...
- <span>https:</span>//sca.mangopay.com?sessionId=sca_s_01J7NV9TTVGXSFH2MKRG98N6N&ReturnURL=https%3A%2F%2Fexample.com
...
<Card title="GET View a User (SCA)" href="/">
