...
International bank wires rely on the **SWIFT network**, which has three options for managing processing fees: 
- **SHA** – The fees are shared between the remitter (sender) and the beneficiary
- **BEN** – The beneficiary bears all fees
- **OUR** – The remitter bears the fees
...
For payouts in USD (only), Mangopay offers the possibility of using OUR (rather than SHA) to allow the platform to bear the cost of international payouts. 

This ensures your beneficiaries are paid in full.
