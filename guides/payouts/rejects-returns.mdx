...
description: Guidance for dealing with payout returns and R-transactions
---
...
To view further details about the request, call the [GET View a Payout](/api-reference/payouts/view-payout) endpoint or, if using SCT Inst ([read more](/guides/payouts/integration#initiate-an-sct-inst-payout)), [GET View a Payout and check mode applied](/api-reference/payouts/view-payout-check-mode-applied).
