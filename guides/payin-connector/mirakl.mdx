...
<td class="table-content">`mgp-external-provider-payment-method`</td>
<td class="table-content">No</td>
<td class="table-content">One of the [supported payment methods](/guides/payin-connector/supported-payment-methods). If the payment method is not supported, this field can be left blank (provided you created it as not required).</td>
</tr>
</tbody>
</table>
...
The Mangopay Pay-In Connector will need settlement data to be able to reconcile the funds entering the Mangopay environment with the payment intents that were previously declared.
