...
<td class="table-content">ExternalProcessingDate</td>
<td class="table-content">Required</td>
<td class="table-content">ISO 8601 date time (YYYY-MM-DDTHH:MM:SSZ)</td>
...
<td class="table-content">String</td>
<td class="table-content">One of the **supported payment methods**. If the payment method is not supported, this optional field can be left blank.</td>
</tr>
<tr>
<td class="table-content">ExternalTransactionStatus</td>
<td class="table-content">Required</td>
...
<td class="table-content">SettlementDate</td>
<td class="table-content">Required</td>
<td class="table-content">ISO 8601 date (YYYY-MM-DD)</td>
...
<td class="table-content">Required</td>
<td class="table-content">String</td>
<td class="table-content">The name of the [supported external providers](/).</td>
</tr>
<tr>
<td class="table-content">TotalSettlementFeesAmount</td>
<td class="table-content">Required</td>
