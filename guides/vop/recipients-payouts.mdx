...
{/* In Sandbox, as in Production, active Bank Account objects have been migrated to Recipients. This means that if you call [GET View a Recipient](/api-reference/recipients/view-recipient) with the Id of a legacy Bank Account. */}
