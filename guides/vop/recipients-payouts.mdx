...
In Production, Mangopay will perform a new VOP check on the legacy Bank Account when you make the GET call, but in Sandbox, we won't. This means that Sandbox legacy Bank Accounts will always return: 
