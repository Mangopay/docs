...
```json 400 - NO_MATCH
{
  "Id": "44312c27-c681-4240-8df9-a2507bcf30d6",
    "Message": "Payout not allowed because Verification of Payee result is NO_MATCH",
    "Type": "invalid_action",
    "Date": 1747666655.0,
    "errors": null
}
```
```json 400 - MATCH_NOT_POSSIBLE
{
    "Id": "d89d76a8-5da5-4454-8df9-fcbace0362a7",
    "Message": "Payout not allowed because Verification of Payee result is MATCH_NOT_POSSIBLE",
    "Type": "invalid_action",
    "Date": 1759405223.0,
    "errors": null
}
