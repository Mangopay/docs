...
The VOP result fields are not returned on the [GET View a Payout](/api-reference/payouts/view-payout) nor [GET View a Payout and check mode applied](/api-reference/payouts/view-payout-check-mode-applied) endpoints.