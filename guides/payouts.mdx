...
Payouts created before the cutoff times outlined above are transferred to the user’s bank account within the corresponding processing times. Payouts created after the cutoff are processed next working day – meaning Monday to Friday excluding weekends and [public holidays](/support/public-holidays).
...
### Cost-bearing for international payouts
