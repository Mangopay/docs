...
This option, using the OUR configuration of <a href="/guides/glossary#international-bank-wires">SWIFT international bank wires</a>, allows platforms to ensure that the beneficiary receives the full amount of USD international payouts. The fees borne by the platform are recuperated by Mangopay during the usual billing cycle.
