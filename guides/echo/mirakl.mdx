...
Mangopay is developing a new connector called **Mangopay Echo** to provide better transparency on funds acquired by other PSPs but which then transit the Mangopay environment. 
...
**Actionable:** When the Mangopay Echo launches (Sandbox: May 2025; Production: June 2025)
</Info>
