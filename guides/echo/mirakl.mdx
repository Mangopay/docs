...
To do this, your platform needs to send CSV files to a dedicated endpoint as soon as they become available. Read more about [providing settlement files to Mangoapy](/guides/echo#provide-settlement-files-to-mangopay).
...
<CardGroup col={2}>
  ...
  >
    Upload settlement files to Mangopay via the API
  </Card>
</CardGroup>