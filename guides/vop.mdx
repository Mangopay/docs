...
sequenceDiagram
  ...
  rect rgb(191, 223, 255)
    ...
    Mangopay->>Payee: Send payment
        Note right of Responding PSP: Payout
  end
```
...
<CardGroup cols={2}>
<Card title="Pay-in" href="/guides/vop/payin" arrow="true" cta="Read more">
...
<Card title="Payout" href="/guides/vop/payout" arrow="true" cta="Read more">
