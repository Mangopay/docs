...
In the Sandbox Dashboard, you can simulate KYC document validation from Mangopay. [Read more](https://mangopay.com/docs/tutorials/submit-kyc-document#simulate-the-response-from-mangopay-in-sandbox)
</Note>
...
**PSD2 changes oblige the marketplace to send us their total daily revenue at D \+ 1\.**  
