...
The process above is the same for each `ClientId` you use, whether in Sandbox or Production.
...
> [POST Create a Cancel of an Intent](/api-reference/intents/cancel-intent)
...
{/* <Card title="PUT Create a Cancel of an Intent" href="/api-reference/intents/cancel-intent">
