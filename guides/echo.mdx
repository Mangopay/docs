            ...
            "pages": [
              {
                ...
                "pages": [
                  ...
                  "api-reference/intents/capture-intent",
                  "api-reference/intents/cancel-intent",
...
- LineItems – A list of items purchased by the buyer. Each line item identifies the Seller (Mangopay user or wallet) and the item purchased (amount, SKU, etc.). It also tracks the amount of the line item that is subsequently captured, refunded, disputed, and so on.
...
<Card title="POST Capture an Intent" href="api-reference/intents/capture-intent">
Declare the full or partial capture of an authorization processed by a third-party PSP
</Card>
<Card title="PUT Cancel an Intent" href="api-reference/intents/cancel-intent">
