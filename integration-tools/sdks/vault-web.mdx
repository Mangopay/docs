...
<table class="html-table">
    ...
    <tbody>
        <tr>
            ...
            <td class="content">string</td>
            <td class="content">The unique identifier of the Card Registration object.</td>
        </tr>
        <tr>
            <td class="content">`CardRegistrationURL`</td>
            <td class="content">string</td>
            <td class="content">The URL to which the card details are sent to be tokenized.</td>
        </tr>
        <tr>
            <td class="content">`AccessKey `</td>
            <td class="content">string</td>
            <td class="content">The secure value used when tokenizing the card.</td>
        </tr>
        <tr>
            <td class="content">`PreregistrationData`</td>
            <td class="content">string</td>
            <td class="content">A specific value passed to the `CardRegistrationURL`.</td>
        </tr>
        <tr>
            <td class="content">`errors`</td>
            <td class="content">MgpTypedError</td>
            <td class="content">A generic type describing the [error report](https://mangopay.com/docs/errors/error-report) that is returned in case of an error.</td>
        </tr>
    </tbody>
</table>
...
<table class="html-table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="content">string</td>
            <td class="content">The unique identifier of the Card object.</td>
        </tr>
        <tr>
            <td class="content">`CardRegistrationURL`</td>
            <td class="content">string</td>
        ...
        <tr>
            ...
            <td class="content">string</td>
            <td class="content">The type of the card.</td>
        </tr>
        <tr>
            <td class="content">`CreationDate`</td>
            <td class="content">timestamp</td>
            <td class="content">The date and time at which the object was created.</td>
        </tr>
        <tr>
            <td class="content">`Currency`</td>
            <td class="content">string</td>
            <td class="content">The currency of the card.</td>
        </tr>
        <tr>
            <td class="content">`Id`</td>
            <td class="content">string</td>
        ...
        <tr>
            <td class="content">`RegistrationData`</td>
            <td class="content">string</td>
            <td class="content">The string returned by the tokenization server after tokenizing the card.</td>
        </tr>
        <tr>
            <td class="content">`ResultCode`</td>
            <td class="content">string</td>
            <td class="content">The code indicating the result of the operation. This information is mostly used to [handle errors](https://mangopay.com/docs/errors/error-codes) or for filtering purposes.</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="content">`UserId`</td>
            <td class="content">string</td>
            <td class="content">The unique identifier of the user the card belongs to.</td>
        </tr>
        <tr>
            <td class="content">errors`</td>
            <td class="content">MgpTypedError</td>
