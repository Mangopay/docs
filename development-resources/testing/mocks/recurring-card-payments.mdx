...
You can use the value below in the `AddressLine2` parameter of the `Billing` object in your recurring pay-in registration body.TW please add the old table here  
