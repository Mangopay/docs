...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">Transaction refused by the bank (Do not honor)</td>
        </tr>
        <tr>
            <th class="header"><strong>Short description</strong></th>
            <td class="content">The transaction has been refused due to restrictions on the issuing bank side.</td>
        </tr>
        <tr>
