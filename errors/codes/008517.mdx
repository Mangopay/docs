---
title: '008517'  
description: '<sup>&#8249; [All error codes](/errors/codes#bank-related)</sup>'
---
...
<table>
    <tbody>
        <tr>
            ...
            <td class="table-content">Transaction refused due to blocked US account</td>
        </tr>
        <tr>
            <th class="header"><strong>Description</strong></th>
            <td class="table-content">The payout cannot be performed because the target US bank account is blocked.</td>
        </tr>
        <tr>
...
This error is triggered when attempting to make a payout to a US bank account that has been blocked by Mangopay’s teams.  
...
In the example below, a payout was made to a blocked US bank account.  
```json API Response
{
    ...
    "Status":"FAILED",
    "ResultCode":"008517",
    "ResultMessage":"Transaction refused due to blocked US account",
    "ExecutionDate":null,
    "Type":"PAYOUT",
    "Nature":"REGULAR",
