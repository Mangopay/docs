...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">PayPal transaction approval has expired</td>
        </tr>
        <tr>
            <th class="header"><strong>Short description</strong></th>
            <td class="content">The pay-in failed because the PayPal account owner did not confirm the payment.</td>
        </tr>
        <tr>
