...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">SecureMode: 3DSecure authentication has failed</td>
        </tr>
        <tr>
            <th class="header"><strong>Short description</strong></th>
            <td class="content">The 3DSecure authentication has failed.</td>
        </tr>
        <tr>
...
2) Make a direct card pay-in with this card (see Card Direct PayIn endpoint).  
...
Upon viewing your pay-in (see View a PayIn endpoint), you will see that the error 101301 is returned in the `ResultCode` parameter.  
