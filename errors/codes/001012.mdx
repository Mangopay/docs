...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">Transaction amount is lower than minimum permitted amount</td>
        </tr>
        <tr>
            <th class="header"><strong>Short description</strong></th>
            <td class="content">The transaction cannot be performed because the amount is lower than the minimum permitted amount.</td>
        </tr>
        <tr>
