...
<table>
    <tbody>
        <tr>
            ...
            <td>Transaction amount is lower than minimum permitted amount</td>
        </tr>
        <tr>
            <th scope="row"><strong>Short description</strong></th>
            <td>The transaction cannot be performed because the amount is lower than the minimum permitted amount.</td>
        </tr>
        <tr>
