...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">Transaction refused due to blocked BIC</td>
        </tr>
        <tr>
            <th class="header"><strong>Short description</strong></th>
            <td class="content">The payout cannot be performed because the target bank is not authorized.</td>
        </tr>
        <tr>
