...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">Due to repudiations against this transaction, you can not refund this amount.</td>
        </tr>
        <tr>
            <th class="header"><strong>Short description</strong></th>
            <td class="content">The refund failed because the pay-in is already being disputed.</td>
        </tr>
        <tr>
