...
<table>
    <tbody>
        <tr>
            ...
            <td>The 3DS authentification has failed due to supplementary security checks</td>
        </tr>
        <tr>
            <th scope="row"><strong>Short description</strong></th>
            <td>The pay-in failed due to supplementary security checks preventing 3DS authentication.</td>
        </tr>
        <tr>
