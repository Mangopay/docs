...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">Transaction refused: the Debited Wallet and the Credited Wallet must be different</td>
        </tr>
        <tr>
            <th class="header"><strong>Short description</strong></th>
            <td class="content">Funds cannot be transferred to the same wallet. </td>
        </tr>
        <tr>
