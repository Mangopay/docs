...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">There are insufficient funds in the bank account</td>
        </tr>
        <tr>
            <th class="header"><strong>Short description</strong></th>
            <td class="content">The pay-in failed due to insufficient funds in the bank account.</td>
        </tr>
        <tr>
