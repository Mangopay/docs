...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">The banking alias is not active</td>
        </tr>
        <tr>
            <th class="header"><strong>Short description</strong></th>
            <td class="content">The pay-in to the ibanized wallet failed because the Banking Alias is not active.</td>
        </tr>
        <tr>
