...
<table>
    <tbody>
        <tr>
            ...
            <td>The PayIn DebitedFunds can't be higher than the PreAuthorization remaining amount</td>
        </tr>
        <tr>
            <th scope="row"><strong>Short description</strong></th>
            <td>The captured funds amount cannot be higher than the preauthorization remaining amount.</td>
        </tr>
        <tr>
