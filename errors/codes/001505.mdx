...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">The PayIn DebitedFunds can't be higher than the PreAuthorization remaining amount</td>
        </tr>
        <tr>
            <th class="header"><strong>Short description</strong></th>
            <td class="content">The captured funds amount cannot be higher than the preauthorization remaining amount.</td>
        </tr>
        <tr>
