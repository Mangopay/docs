...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">User has not been redirected then the payment session has expired</td>
        </tr>
        <tr>
            <th class="header"><strong>Short description</strong></th>
            <td class="content">The pay-in failed because the user wasn’t redirected to the payment page.</td>
        </tr>
        <tr>
