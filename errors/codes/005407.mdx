...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">Duplicated operation: you cannot reimburse the same amount more than once for a transaction during the same day.</td>
        </tr>
        <tr>
            <th class="header"><strong>Short description</strong></th>
            <td class="content">The refund failed because the same amount as already been refunded in the last 24 hours for the initial transaction.</td>
        </tr>
        <tr>
