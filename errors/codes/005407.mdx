...
<table>
    <tbody>
        <tr>
            ...
            <td>Duplicated operation: you cannot reimburse the same amount more than once for a transaction during the same day.</td>
        </tr>
        <tr>
            <th scope="row"><strong>Short description</strong></th>
            <td>The refund failed because the same amount as already been refunded in the last 24 hours for the initial transaction.</td>
        </tr>
        <tr>
