...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">Transaction refused due to blocked OTHER account</td>
        </tr>
        <tr>
            <th class="header"><strong>Short description</strong></th>
            <td class="content">The payout cannot be performed because the target OTHER bank account is blocked.</td>
        </tr>
        <tr>
