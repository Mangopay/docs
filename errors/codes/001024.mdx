...
In the example below, find the API response when using the <a href="/api-reference/direct-debit-payins/create-direct-debit-payin">Create a Direct Debit PayIn</a> endpoint to make a pay-in with an AuthorId different from the Mandate UserId.  
```json API Response
{
    "Id": "163263010",
