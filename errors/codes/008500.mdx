...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">Transaction blocked by Fraud Policy</td>
        </tr>
        <tr>
            <th class="header"><strong>Short description</strong></th>
            <td class="content">This payment was blocked by the platform’s fraud prevention rules or Mangopay’s policy.</td>
        </tr>
        <tr>
