...
<table>
    <tbody>
        <tr>
            ...
            <td>Duplicate transaction identified</td>
        </tr>
        <tr>
            <th scope="row"><strong>Short description</strong></th>
            <td>An instant payment has already been made to the same bank account for the same amount in the last 24 hours.</td>
        </tr>
        <tr>
