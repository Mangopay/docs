...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">Duplicate transaction identified</td>
        </tr>
        <tr>
            <th class="header"><strong>Short description</strong></th>
            <td class="content">An instant payment has already been made to the same bank account for the same amount in the last 24 hours.</td>
        </tr>
        <tr>
