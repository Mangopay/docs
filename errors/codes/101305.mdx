...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">SecureMode: Soft decline</td>
        </tr>
        <tr>
            <th class="header"><strong>Short description</strong></th>
            <td class="content">Strong customer authentication is required in order to be able to proceed to the payment due to soft decline.</td>
        </tr>
        <tr>
