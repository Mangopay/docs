...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">The Status of this Mandate does not allow for payments</td>
        </tr>
        <tr>
            <th class="header"><strong>Short description</strong></th>
            <td class="content">The pay-in failed due to the status of the corresponding mandate.</td>
        </tr>
        <tr>
