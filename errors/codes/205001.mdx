...
On <a href="/api-reference/recurring-card-payins/recurring-payin-object">recurring card pay-ins</a>, this error may also be caused when the 101st pay-in is attempted against the same registration object. One registration object can only be used for a maximum of 100 pay-ins, both CIT and MIT included.
