...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">Balance of client fee wallet unsufficient</td>
        </tr>
        <tr>
            <th class="header"><strong>Short description</strong></th>
            <td class="content">The refund failed because the fees exceeds the balance of the Fees Wallet.</td>
        </tr>
        <tr>
