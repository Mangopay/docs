...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">User has let the payment session expire without paying</td>
        </tr>
        <tr>
            <th class="header"><strong>Short description</strong></th>
            <td class="content">The user has let the payment session expire.</td>
        </tr>
        <tr>
...
<a href="#" class="btn Primary normal">Testing payment methods</a>  
