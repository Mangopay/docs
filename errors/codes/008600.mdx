...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">Wallet blocked by Fraud policy</td>
        </tr>
        <tr>
            <th class="header"><strong>Short description</strong></th>
            <td class="content">The wallet has been blocked because it doesn’t comply with Mangopay’s anti-fraud rules.</td>
        </tr>
        <tr>
