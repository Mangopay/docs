...
<table>
    <tbody>
        <tr>
            ...
            <td>Direct debit is not enabled for this bank account</td>
        </tr>
        <tr>
            <th scope="row"><strong>Short description</strong></th>
            <td>The mandate cannot be created because direct debit is not supported for this bank account.</td>
        </tr>
        <tr>
