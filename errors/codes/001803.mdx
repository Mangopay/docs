...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">Direct debit is not enabled for this bank account</td>
        </tr>
        <tr>
            <th class="header"><strong>Short description</strong></th>
            <td class="content">The mandate cannot be created because direct debit is not supported for this bank account.</td>
        </tr>
        <tr>
