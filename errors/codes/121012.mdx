...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">Inapproriate bank account type used</td>
        </tr>
        <tr>
            <th class="header"><strong>Short description</strong></th>
            <td class="content">The payout has been rejected by Mangopay’s team because the bank account is not of the correct type.</td>
        </tr>
        <tr>
