...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">CVV: missing or invalid format</td>
        </tr>
        <tr>
            <th class="header"><strong>Short description</strong></th>
            <td class="content">The card verification code information provided for the card registration is either invalid or missing.</td>
        </tr>
        <tr>
