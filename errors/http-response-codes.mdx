...
<table>
    <tbody>
        ...
        <tr>
            <td class="table-content">501</td>
            <td class="table-content">Not Implemented</td>
            <td class="table-content">The request cannot be fulfilled because the feature is not implemented (e.g., refunds for bank wire pay-ins).</td>
        </tr>
    </tbody>
</table>
