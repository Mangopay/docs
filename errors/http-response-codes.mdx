...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td class="table-content">The request is not processed due to an identical [idempotency key](api-reference/idempotency).</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="table-content">Too many requests have been sent in a given period of time ([rate limiting](api-reference/rate-limiting)).</td>
        </tr>
        <tr>
