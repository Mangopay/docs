...
### Example HTTP errors
The following examples show the HTTP error report. Further examples are given on each endpoint where relevant and valuable.
...
```json
{
    ...
    "Date": 1740580882,
    "errors": {
        "RessourceNotFound": "Cannot found the ressource PayIn with the id=3874745529 "
    }
}
```
