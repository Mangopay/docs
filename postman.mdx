...
<table class="horizontal-table">
    <tbody>
        <tr>
            ...
            <td class="content">Use the calls in the displayed order to go through a whole workflow (corresponding to a business model example).</td>
        </tr>
        <tr>
            <th class="header">Feature&#8209;oriented</th>
            <td class="content">Use the calls displayed in the displayed order to learn more about a feature. Activation of the feature or previous steps may be required.</td>
        </tr>
        <tr>
            <th class="header">Endpoint&#8209;oriented</th>
            <td class="content">Find your API calls organized in the same way as they are in the Mangopay endpoints documentation.</td>
        </tr>
    </tbody>
</table>
