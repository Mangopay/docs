...
To find out more details about which local entities are considered as which type, see the [Requirements for legal users](https://www.google./fr).

<Warning>
**Partnership type is only for specific structures**
