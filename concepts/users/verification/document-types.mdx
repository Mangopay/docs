...
<Card title="Shareholder declaration">  
 A Mangopay form allowing a legal entity to detail its <glossary:beneficial-owner>beneficial owners</glossary>, signed by the <glossary:legal-representative>legal representative</glossary>.   
...
For legal users, the identity proof of the <glossary:legal-representative>legal representative</glossary> is required and other documents are required depending on the type and jurisdiction of the user. For more information, see:   
