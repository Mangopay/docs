...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>Legal user – Business, Partnership, Organization</td>
            <td>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>Request a payout to their bank account **unless they have been verified**. Find out more about [Verification](concepts/users/verification/introduction).</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>Legal user – Partnership, Organization</td>
            <td>
                - Registered name of the entity
                - Email for the entity
                - Registered address of the entity’s headquarters
