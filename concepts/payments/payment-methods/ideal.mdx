...
With iDEAL, refunds can be made up to one year after the initial transaction.  

<Card title="Article">Refunds</Card>  

## Disputes  

Users authenticate their iDEAL payments directly with their bank, so there is no dispute process and a low risk of unrecognized or fraudulent payments.  
