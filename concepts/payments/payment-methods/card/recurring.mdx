...
Recurring card payments are when the <glossary:platform>platform</glossary> repeatedly charges the end user’s card at regular intervals for the goods and/or services provided.   
...
<Card title="Customer-initiated transaction (CIT)">  
 An initial transaction in the presence of the cardholder, which will be subject to <glossary:sca>SCA</glossary>. No exemption is possible on a CIT.  
</Card>  
...
<a href="#" class="btn Secondary normal">Learn more about 3DS and SCA</a>  
...
<Steps> 
<Step>Create the Recurring Registration object to store information about the future recurring payments.</Step> 
<Step>Process the first recurring payment (CIT) within 24 hours of the card registration.</Step> 
<Step>Process the subsequent recurring payments (MIT) at the defined intervals.</Step>  
</Steps>  
...
By ensuring <glossary:sca>SCA</glossary> is completed prior to the first actual debit, free cycles benefit:  
...
<Card title="Tutorial">How to process a reccuring card payment</Card>  

<Card title="Endpoints">Recurring card payments</Card>