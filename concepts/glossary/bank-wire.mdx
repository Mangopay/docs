...
A bank wire, whether a pay-in or a payout, is in reality a bank-to-bank movement, with Mangopay, a licensed <glossary:emi>electronic money institution</glossary>, on one side and the user’s bank on the other.  
