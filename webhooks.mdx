...
The IPs below are redacted for security reasons. When your platform is looking to test webhooks in Sandbox, contact Mangopay <a href="https://hub.mangopay.com/" target="_blank">via the Hub</a> for the full list. 
</Note>
