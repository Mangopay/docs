...
<Card title="Endpoint" href="/api-reference/users/update-natural-user">Update a natural user</Card> 

<Card title="How to">How to turn a Payer into a Owner (legal users)</Card>  

<Card title="Guide">User categories</Card>  

<Card title="Guide">User verification process</Card>