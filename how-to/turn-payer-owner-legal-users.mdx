...
<Card title="Endpoint" href="/api-reference/users/update-legal-user">Update a Legal User</Card> 

<Card title="How to" href="/how-to/turn-payer-owner-natural-users">How to turn a Payer into a Owner (natural users)</Card>  
