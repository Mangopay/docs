...
<Card title="Guide" href="/guides/payment-methods/banking/direct-debit">Direct debit</Card>  
...
<Card title="Testing" href="/testing/payment-methods">Payment methods</Card>