...
import ReturnURL4 from '/snippets/body-parameters/ReturnURL4.mdx';
...
import HostedUrlResponse from '/snippets/response-parameters/HostedUrlResponse.mdx';
import Status13Response from '/snippets/response-parameters/Status13Response.mdx';
import ReturnURL3Response from '/snippets/response-parameters/ReturnURL3Response.mdx';
import IdentityVerificationId from '/snippets/path-parameters/IdentityVerificationId.mdx';
