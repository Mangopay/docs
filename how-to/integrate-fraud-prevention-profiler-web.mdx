...
sidebarTitle: "Integrate fraud prevention profiler - Web"
'og:description': "Step-by-step guide to integrating the fraud prevention profiler on websites."
description: "This how-to guide covers integrating the profiler on your website."
---
...
<Note>
    **Note – Not necessary if using Checkout SDK**
    ...
    Mangopay’s [Checkout SDK](integration-tools/sdks/checkout) has the profiler built in, generating and returning the ProfilingAttemptReference for a transaction.
</Note>
...
Insert the following initialization sample in the code of your website checkout page, after any other scripts and just before the closing _body_ tag. 
