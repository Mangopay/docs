...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td class="content">Information about the card to use for the transaction.</td>
        </tr>
        <tr>
            <td class="content">`Number`</td>
            <td class="content">string</td>
            <td class="content">The number of the card (on the front, usually 16 digits).</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="content">`CVX`</td>
            <td class="content">string</td>
            <td class="content">The card verification code (CVC) of the card (on the back, usually 3 digits).</td>
        </tr>
    </tbody>
</table>
