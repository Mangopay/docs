...
sidebarTitle: 'Process a Google Pay payment'
...
For an overview of the data flows, see the Google Pay concepts article. To integrate Google Pay on your side, see the Google Pay documentation.  
...
<Card title="Article">Google Pay - How it works</Card>  
