...
If the user that you’re updating to Owner has the `KYCLevel` value `REGULAR`, they will be [downgraded](/guides/users/policies/verification-downgrade) to LIGHT if the following values are modified:
...
In this case, they will be required to submit KYC Documents to regain their [verification](/guides/users/verification/introduction) and be able to request payouts.
</Warning>
...
If Mangopay categorizes a user as an Owner and their `KYCLevel` is `REGULAR`, they may be to `LIGHT` (as per the [verification downgrade](/guides/users/policies/verification-downgrade)) if you subsequently update any of the following parameters:
...
<table>
    ...
    <tbody>
        <tr>
            <td class="content">UserCategory</td>
            <td class="content">REQUIRED</td>
            <td class="content">REQUIRED</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="content">CountryOfResidence</td>
            <td class="content">null</td>
            <td class="content">REQUIRED</td>
        </tr>
        <tr>
            ...
            <td class="content">null</td>
            <td class="content">OPTIONAL</td>
        </tr>
        <tr>
            <td class="content">IncomeRange</td>
            <td class="content">null</td>
            <td class="content">OPTIONAL</td>
        </tr>
        <tr>
            <td class="content">TermsAndConditionsAccepted</td>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td class="content">LegalPersonType</td>
            <td class="content">REQUIRED</td>
            <td class="content">REQUIRED</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="content">LegalRepresentativeFirstName</td>
            <td class="content">REQUIRED</td>
            <td class="content">REQUIRED</td>
        </tr>
        <tr>
            <td class="content">LegalRepresentativeLastName</td>
            <td class="content">REQUIRED</td>
            <td class="content">REQUIRED</td>
        </tr>
        <tr>
            <td class="content">HeadquartersAddress</td>
            <td class="content">null</td>
            <td class="content">REQUIRED</td>
        </tr>
        <tr>
            <td class="content">CompanyNumber</td>
            <td class="content">null</td>
            <td class="content">REQUIRED</td>
        </tr>
        <tr>
            <td class="content">LegalRepresentativeBirthday</td>
            <td class="content">null</td>
            <td class="content">REQUIRED</td>
        </tr>
        <tr>
            <td class="content">LegalRepresentativeNationality</td>
            <td class="content">null</td>
            <td class="content">REQUIRED</td>
        </tr>
        <tr>
            <td class="content">LegalRepresentativeCountryOfResidence</td>
            <td class="content">null</td>
            <td class="content">REQUIRED</td>
        </tr>
        <tr>
            <td class="content">LegalRepresentativeEmail</td>
            <td class="content">null</td>
            <td class="content">OPTIONAL</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="content">LegalRepresentativeAddress</td>
            <td class="content">OPTIONAL</td>
            <td class="content">OPTIONAL</td>
        </tr>
    </tbody>
