...
The full string must be less than 50 characters, meaning that there are 14 characters available for the `ClientId`. If your Sandbox or Production `ClientId` is longer than 14 characters, you need to truncate it to 14 characters.  
</Warning>  
...
For an overview of the data flows, see the Apple Pay concepts article.  
...
<CardGroup col={2}>
    <Card title="Guide" href="/guides/payment-methods/apple-pay">Learn more about Apple Pays</Card>  
