...
import DownloadLink from '/snippets/components/DownloadLink.mdx'
...
You can download the logo assets and guidelines in this <DownloadLink fileName="Powered by Mangopay logo - Assets and guidelines" filePath="/logo/powered-by-mangopay.zip" linkText="compressed ZIP folder" />. 
</Accordion>
