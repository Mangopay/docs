...
> http<span>://www</span>.example.com?EventType=REPORT_READY_FOR_DOWNLOAD&ResourceId=`ReportId`&Date=`ReportDate`
...
In order to optimize the report, you can take advantage of a series of filters available in the <a href="/api-reference/reports/create-wallets-report">Create a Wallets Report</a> endpoint documentation.  
