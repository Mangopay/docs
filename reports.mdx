...
### Generate a report via the Dashboard 
...
<Steps>
  ...
  <Step title="Generate the report">
    ...
    - USER_WALLET_TRANSACTIONS – Filter
...
If the ReportType is USER_WALLET_TRANSACTIONS, the following filters and filter combinations can be used to generate a report containing the following transactions:

- UserId – Report uses the value to contain only transactions where the value is the AuthorId of the transaction
- WalletId – The 
