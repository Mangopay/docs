...
List all transactions crediting or debiting your platform’s Fees Wallet – pay-ins, transfers, refunds, and payouts where your platform has set a positive or negative `FEES` amount
</Card>
</CardGroup>
...
List transactions crediting or debiting user wallets – pay-ins, transfers, conversions, and payouts, as well as refunds of all types and repudiations (from chargebacks)
</Card>
</CardGroup>
...
<Card title="Settlements" href="/reports/echo">
...
<Card title="Splits" href="/reports/echo">
