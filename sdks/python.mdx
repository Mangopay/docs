...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="table-content">Platforms that have contracted with Mangopay’s UK entity (MANGOPAY U.K. LIMITED) must include the following header in all requests. If you’re using an SDK, you need to set it to <inline-code>true</inline-code>.</td>
        </tr>
    </tbody>
</table>  
