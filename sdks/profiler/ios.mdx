...
<Note>
    **Note - Contact Mangopay**
    ...
    If you want to use the <a href="https://www.swift.org/package-manager/" target="_blank">Swift Package Manager</a> option, contact your assigned solutions engineer to create a Swift Package Manager repository for you.  
</Note>
