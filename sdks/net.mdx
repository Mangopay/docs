...
<a href="#" class="btn Primary normal">Mangopay .NET SDK</a>  
...
<table class="html-table">
    ...
    <tbody>
        ...
        <tr>
            <td class="content">`LoggerFactoryAdapter`</td>
            <td class="content">ILoggerFactoryAdapter</td>
            <td class="content">`NoOpLoggerFactoryAdapter()`</td>
            <td class="content">Logger adapter implementation. Disabled by default.</td>
        </tr>
        <tr>
...
<a href="#" class="btn Secondary normal">Report and issue</a>