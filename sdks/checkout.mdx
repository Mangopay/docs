...
- [GitHub Example apps – Web](https://github.com/Mangopay/mangopay-checkout-web/tree/main/examples) (including [deployed demo](https://checkout-demo-mangopay.netlify.app/))
