        ...
        <tr>
            ...
            **REQUIRED**</td>
            <td class="table-content">
                ...
                **Allowed values:** [visa, masterCard](https://developer.apple.com/documentation/applepayontheweb/applepaypaymentrequest/supportednetworks)
            </td>
        </tr>
        <tr>
    ...
    <tbody>
        ...
        <tr>
            ...
            Unique identifier for your PayPal business account, required to process pay-ins.
				Production: Available in your [PayPal Business Account page](/api-reference/paypal/create-paypal-payin)
https://www.paypal.com/us/cshelp/article/how-do-i-find-my-secure-merchant-id-on-my-paypal-account-help538
