...
After the SDK has been initialized you can update options if needed without the need of full process of reinitialization by using `updateOptions` method. Make sure you pass fully opdate `options` object as specified in Configuration section.
