...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="table-content">Triggered when the payment process is canceled by the shopper. This can occur when the 3D Secure authentication window, PayPal popup, Google Pay popup, or Apple Pay popup is closed before completion.</td>
        </tr>
    </tbody>
</table>
