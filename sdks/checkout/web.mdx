...
- A card to register or payment method setup (see [Testing - Payment methods](testing/payment-methods.mdx) for testing information)  
...
- [Deactivate a Card](/api-reference/cards/deactivate-card) allows you to irreversibly set the card as inactive  
...
- [The Direct Card PayIn object](/api-reference/card-validations/card-validation-object), for one-shot card payments  
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="table-content">String</td>
            <td class="table-content">One of the [Mangopay-supported currencies](/api-reference/overview/data-formats) in the ISO_4217 format.</td>
        </tr>
        <tr>
