...
<table>
    ...
    <tbody>
        <tr>
            <td class="content">script-src</td>
            <td class="content">*.google.com</td>
        </tr>
        <tr>
            <td class="content">connect-src</td>
            <td class="content">	
                api.mangopay.com
...
<table>
    ...
    <tbody>
        <tr>
            <td class="content">`elementOrSelector`</td>
            <td class="content">
                HTMLElement | String
                **REQUIRED**
            </td>
            <td class="content">The container element or the selector of the container element.</td>
        </tr>
        <tr>
            <td class="content">`options`</td>
            <td class="content">
                Object 
                **REQUIRED**
            </td>
            <td class="content">The options of the Checkout SDK configuration.</td>
        </tr>
    </tbody>
</table>  
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td class="content">`profilingMerchantId`</td>
            <td class="content">
                String
                **REQUIRED**
            </td>
            <td class="content">The unique identifier associated with your fraud protection package. Contact Mangopay to obtain this value.</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="content">`paymentMethods`</td>
            <td class="content">
                Array
                **REQUIRED**
            </td>
        ...
        <tr>
            <td class="content">`branding`</td>
            <td class="content">Object</td>
            <td class="content">The custom branding of the payment page (see Customization section below).</td>
        </tr>
        <tr>
            <td class="content">`locale`</td>
            <td class="content">String | Object</td>
            <td class="content">The language for the payment page. Specify one of the built-in languages (`en`, `fr`) or send an object with custom messages (see Customization section below).</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            <td class="content">`ref`</td>
            <td class="content">React.RefObject</td>
            <td class="content">React reference object: `import { MangopayCheckoutForwardedRef } from '@mangopay/checkout-sdk-react';`</td>
        </tr>
        <tr>
            <td class="content">`options`</td>
            <td class="content">Object</td>
            <td class="content">Checkout SDK configuration options</td>
        </tr>
        <tr>
            <td class="content">`disabled`</td>
            <td class="content">Boolean</td>
            <td class="content">Applies a disabled state to the Checkout component such that user input is not accepted.</td>
        </tr>
        <tr>
            <td class="content">`onError`</td>
            <td class="content">Function(event)</td>
            <td class="content">Triggered when an internal SDK error has occurred.</td>
        </tr>
        <tr>
            <td class="content">`onLoaded`</td>
            <td class="content">Function(event)</td>
            <td class="content">Triggered when the Checkout SDK is loaded.</td>
        </tr>
        <tr>
            <td class="content">`onChange`</td>
            <td class="content">Function(event)</td>
            <td class="content">Triggered when data exposed by the Checkout SDK is changed.</td>
        </tr>
        <tr>
            <td class="content">`onTokenizationComplete`</td>
            <td class="content">Function(event)</td>
            <td class="content">
                Triggered when:
        ...
        <tr>
            <td class="content">`onPaymentComplete`</td>
            <td class="content">Function(event)</td>
            <td class="content">Triggered when the transaction is completed, whatever the outcome (whether successful or failed).</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            <td class="content">`options.supportedCardBrands`</td>
            <td class="content">Array
                **REQUIRED**</td>
            <td class="content">
        ...
        <tr>
            <td class="content">`options.onCreateCardRegistration`</td>
            <td class="content">Function
                **REQUIRED**</td>
            <td class="content">Use this attribute to request and return a Card Registration.</td>
        </tr>
        <tr>
            <td class="content">`options.onCreatePayment`</td>
            <td class="content">Function
                **REQUIRED**</td>
            <td class="content">To handle 3DS redirects for card payments, use this attribute to request and return a pay-in.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="content">String</td>
            <td class="content">One of the Mangopay-supported currencies in the ISO_4217 format.</td>
        </tr>
        <tr>
            <td class="content">`merchantCapabilities`</td>
            <td class="content">Array</td>
            <td class="content">Information about the card types and authentication protocols you support (see Apple Pay documentation).</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="content">Object</td>
            <td class="content">The line item total for the payment (see Apple Pay documentation).</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="content">`merchantName`</td>
            <td class="content">String</td>
            <td class="content">The name of your platform.</td>
        </tr>
        <tr>
            <td class="content">`onValidateMerchant`</td>
            <td class="content">Function</td>
            <td class="content">Function called when the SDK receives an onvalidatemerchant merchant event from the Apple Pay sheet. This function should implement backend creation of the merchant session object. After creating the session object, return the session object to the SDK.</td>
        </tr>
    </tbody>
</table> 
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td class="content">Array</td>
            <td class="content">The billing information to fulfill the order (see Apple Pay documentation).</td>
        </tr>
        <tr>
            <td class="content">`requiredShippingContactFields`</td>
            <td class="content">Array</td>
            <td class="content">The shipping information to fulfill the order (see Apple Pay documentation).</td>
        </tr>
        <tr>
            <td class="content">`billingContact`</td>
            <td class="content">Object</td>
            <td class="content">The billing contact information for the user (see Apple Pay documentation).</td>
        </tr>
        <tr>
            <td class="content">`shippingContact`</td>
            <td class="content">Object</td>
            <td class="content">The shipping contact information for the user (see Apple Pay documentation).</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            <td class="content">`epochTimestamp`</td>
            <td class="content">Number</td>
        </tr>
        <tr>
            <td class="content">`expiresAt`</td>
            <td class="content">Number</td>
        </tr>
        <tr>
            <td class="content">`merchantSessionIdentifier`</td>
            <td class="content">String</td>
        </tr>
        <tr>
            <td class="content">`nonce`</td>
            <td class="content">String</td>
        </tr>
        <tr>
            <td class="content">`merchantIdentifier`</td>
        ...
        <tr>
            <td class="content">`domainName`</td>
            <td class="content">String</td>
        </tr>
        <tr>
            <td class="content">`displayName`</td>
            <td class="content">String</td>
        </tr>
        <tr>
...
<table>
    ...
    <tbody>
        <tr>
            <td class="content">`merchantId`</td>
            <td class="content">String</td>
            <td class="content">Your Mangopay `ClientId`.</td>
        </tr>
        <tr>
            <td class="content">`merchantName`</td>
            <td class="content">String</td>
            <td class="content">The name of your platform. If a merchant is recognized, the message displayed in the payment sheet is “Pay Unverified Merchant”.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            <td class="content">`allowedAuthMethods`</td>
            <td class="content">Array</td>
            <td class="content">
        ...
        <tr>
            <td class="content">`allowedCardNetworks `</td>
            <td class="content">Array</td>
            <td class="content">
                The card networks supported by Mangopay: VISA and MASTERCARD.
...
<table>
    ...
    <tbody>
        <tr>
            <td class="content">`buttonColor`</td>
            <td class="content">String</td>
            <td class="content">
        ...
        <tr>
            <td class="content">`buttonType`</td>
            <td class="content">String</td>
            <td class="content">
                **Default value:** buy
        ...
        <tr>
            <td class="content">`buttonLocale`</td>
            <td class="content">String</td>
            <td class="content">
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td class="content">Function
                **REQUIRED**</td>
            <td class="content">Use this attribute to request and return a PayPal pay-in.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            <td class="content">`paymentMethod`</td>
            <td class="content">Object</td>
            <td class="content">The payment method used with the card form element. Only `'card’` is supported. See payment methods for more details.
