...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="table-content">This gives developers control over making card registration creation optional during the Payment session. It is only called when the user taps the "Pay" button for card payment.</td>
        </tr>
        <tr>
...
z
Refer to [configuring Apple Pay](#configuring-apple-pay) for more information
</Step>
