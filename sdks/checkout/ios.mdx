...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td class="table-content">A [Direct Card PayIn](/api-reference/payment-methods/card/direct-card-pay-ins/direct-card-payin-object).</td>
        </tr>
        <tr>
            <td class="table-content">`preauthorized`</td>
            <td class="table-content">A card [Preauthorization](/api-reference/payment-methods/card/preauthorizations/preauthorization-object).</td>
        </tr>
        <tr>
            <td class="table-content">`cardValidated `</td>
            <td class="table-content">A [Card Validation](/api-reference/payment-methods/card/card-validations/card-validation-object).</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="table-content">String</td>
            <td class="table-content">One of the [Mangopay-supported currencies](/api-reference/data-formats) in the ISO_4217 format.</td>
        </tr>
        <tr>
