...
<Card
  title="Guide"
  href="/guide/fraud-prevention"
>
  Fraud prevention powered by Nethone
</Card>
...
<CardGroup col={2}>
  ...
  How to integrate the profiler on websites
  </Card>
  <Card title="How to" href="/sdks/profiler/ios">
  How to integrate the profiler in iOS applications
  </Card>
  <Card title="How to" href="/sdks/profiler/android">
  How to integrate the profiler in Android applications
  </Card>
</CardGroup>
...
- [Create a Web Card PayIn](/api-reference/direct-card-payins/create-direct-card-payin)
...
- [Create a BLIK PayIn](/api-reference/blik/create-blik-payin)
