...
You can then use the _**Sandbox operations**_ view of the Dashboard to process the payout.  
...
<CardGroup col={2}> 
    ...
    <Card title="How to" href="/how-to/process-instant-payout">Learn how to process an Instant Payout</Card>  
</CardGroup>