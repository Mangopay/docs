...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">4970107111111119</td>
        </tr>
        <tr>
            <th class="header">**Expiry date**</th>
            <td class="content">Any future date (month/year)</td>
        </tr>
        <tr>
            <th class="header">**CVC**</th>
            <td class="content">Any three digits</td>
        </tr>
        <tr>
            <th class="header">**Currencies**</th>
            <td class="content">AED, AUD, CAD, CHF, CZK, DKK, EUR, GBP, HKD, JPY, NOK, PLN, SEK, TWD, USD, and ZAR.</td>
        </tr>
    </tbody>
</table>
...
<table>
    <tbody>
        <tr>
            <th class="header">**Card number**</th>
            <td class="content">4970105181818183</td>
        </tr>
        <tr>
            <th class="header">**Expiry date**</th>
            <td class="content">Any future date (month/year)</td>
...
<table>
    <tbody>
        <tr>
            <th class="header">**Card number**</th>
            <td class="content">5033951000000004</td>
        </tr>
        <tr>
            <th class="header">**Expiry date**</th>
            <td class="content">Any future date (month/year)</td>
...
<table>
    <tbody>
        <tr>
            <th class="header">**Card number**</th>
            <td class="content">375989111111119</td>
        </tr>
        <tr>
            <th class="header">**Expiry date**</th>
            <td class="content">Any future date (month/year)</td>
...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">FR7630004000031234567890143</td>
        </tr>
        <tr>
            <th class="header">**`BIC`**</th>
            <td class="content">BNPAFRPP</td>
        </tr>
    </tbody>
</table>
...
<table>
    <tbody>
        <tr>
            ...
            <td class="content">55779911</td>
        </tr>
        <tr>
            <th class="header">**`SortCode`**</th>
            <td class="content">200000</td>
        </tr>
    </tbody>
</table>
