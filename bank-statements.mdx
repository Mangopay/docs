...
- [Create a Recurring PayIn (CIT)](/api-reference/recurring-card-payins/create-recurring-payin-cit)  
- [Create a Recurring PayIn (MIT)](/api-reference/recurring-card-payins/create-recurring-payin-mit)  
...
**Endpoint:** 
- [Create a Payout](/api-reference/payouts/create-payout)
