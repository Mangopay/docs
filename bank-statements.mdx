...
- <a href="/api-reference/blik/create-blik-payin">Create a BLIK PayIn</a>
...
- <a href="/api-reference/multibanco/create-multibanco-payin">Create an Multibanco PayIn</a>
...
- <a href="/api-reference/direct-debit/create-direct-debit-payin">Create a Direct Direct-Debit PayIn</a> (if Mandate Scheme is SEPA)
