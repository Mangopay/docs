...
import JavaAddTrackingPaypalPayin from '/snippets/code/java-add-tracking-information-paypal-payin.mdx';
...
This endpoint requires the `payins_tracking_write` scope.
