...
Each pay-in requires a separate `DataCollectionId`.

<Note>
**Note – Contact Mangopay for integration directions**

The request parameters described below are required for marketplace businesses.

Additional data points are required for platforms operating in the following industries, and platforms should contact Mangopay <a href="https://hub.mangopay.com/" target="_blank">via the Dashboard</a> before integrating this endpoint:
- 
{/* 
TO DO ///////////////////////////////////////////
 */}
