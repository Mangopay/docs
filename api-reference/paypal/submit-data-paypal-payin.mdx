...
This endpoint allows your platform to submit data to PayPal in advance of requesting a transaction ([read guide](/guides/payment-methods/paypal#submit-pre-transaction-data)). 
