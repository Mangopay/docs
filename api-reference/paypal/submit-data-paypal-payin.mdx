...
Before integrating this endpoint, platforms operating the verticals above need to contact Mangopay <a href="https://hub.mangopay.com/" target="_blank">via the Dashboard</a>.
</Note>
