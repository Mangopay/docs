...
<TrackingsResponse /></Accordion><Accordion title="400 Shipping required if ShippingPreference is SET_PROVIDED_ADDRESS"></Accordion><Accordion title="400 DebitedFunds amount must equal LineItems total"></Accordion></AccordionGroup>  
