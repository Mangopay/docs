...
To activate BLIK for your platform (including Sandbox), contact Mangopay <a href="https://hub.mangopay.com/" target="_blank">via the Hub</a>.  
</Note>  
...
<Card title="Guide" href="/guides/payment-methods/blik">Learn more about BLIK</Card>