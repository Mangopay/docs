...
You need to send one file per currency, as soon as it becomes available. Read more about [providing settlement files to Mangoapy](/guides/echo#provide-settlement-files-to-mangopay).
