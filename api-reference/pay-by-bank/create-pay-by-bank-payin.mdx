...
Functional errors (`ResultCode`) are possible on a 200 response. [Read more](api-reference/pay-by-bank/pay-by-bank-payin-object) **&rarr;**

<AccordionGroup>
<Accordion title="400 - IBAN not valid">
```json
{
...
<Accordion title="400 - BIC not valid">
```json
{
    "Message": "One or several required parameters are missing or incorrect. An incorrect resource ID also raises this kind of error.",
