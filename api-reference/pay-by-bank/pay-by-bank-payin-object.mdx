...
The Pay by Bank PayIn object allows platforms to process open banking payments via Tink, where the user authenticates directly with their bank to confirm the payment.
