...
The Pay by Bank PayIn object allows platforms to process open banking payments, where the user authenticates directly with their bank to confirm the payment. [Read more](/guides/payment-methods/pay-by-bank) **&rarr;**
