...
Requests to generate an OAuth token use the application/x-www-form-urlencoded Content-Type. See more information in [OAuth 2.0 authentication](/api-reference/overview/authentication#oauth-2-0-authentication).  
</Note>
