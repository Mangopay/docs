...
You can manage your platform's Sandbox and Production API accounts in the <a href="https://hub.mangopay.com/" target="_blank">Dashboard</a> (***Developers*** > ***API accounts***).
...
Once a key has been created, its alias and scopes cannot be changed.
...
Standard API security practice is to rotate your Production keys at regular intervals, such as every few months or less.

You can rotate an API key by resetting it, and keeping the same scopes and alias, or by revoking it and creating a new one.
</Check>
