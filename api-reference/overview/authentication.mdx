...
<table class="header-column">
    <tbody>
        <tr>
            ...
            <td class="content">POST   `/v2.01/oauth/token` </td>
        </tr>
        <tr>
            <th class="header">Authorization</th>
            <td class="content">Basic RXhhbXBsZU...J1aVBqbVFu  </td>
        </tr>
        <tr>
            <th class="header">Content-Type</th>
            <td class="content">application/x-www-form-urlencoded</td>
        </tr>
        <tr>
            <th class="header">Request body</th>
            <td class="content">grant_type=client_credentials</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            <td class="content">`access_token`</td>
            <td class="content">The access token to use to authenticate.</td>
        </tr>
        <tr>
            <td class="content">`token_type`</td>
            <td class="content">The type of token: Bearer.</td>
        </tr>
        <tr>
            <td class="content">`expires_in`</td>
            <td class="content"> 
            ...
            **Default values:** 3600 (in Production), 1200 (in Sandbox)
            ...
            _Note: The value may differ from the default values, therefore you should not rely on hard-coded defaults but on the `expires_in` value returned._
            </td>
        </tr>
    </tbody>
</table>
