...
- If a new endpoint is added to an existing scope, keys already assigned the scope automatically gain access to the new endpoint. This also applies to scope permissions that contain no endpoints today.
