...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td class="table-content">`http://api.mangopay.com/v2/ClientId/users/UserId/bank-details?page=1&amp;per_page=10&quot;&gt;; rel=&quot;first`</td>
        </tr>
        <tr>
            <td class="table-content">Previous page</td>
            <td class="table-content">`http://api.mangopay.com/v2/ClientId/users/UserId/bank-details?page=1&amp;per_page=10&quot;&gt;; rel=&quot;prev`</td>
        </tr>
        <tr>
            <td class="table-content">Next page</td>
            <td class="table-content">`http://api.mangopay.com/v2/ClientId/users/UserId/bank-details?page=1&amp;per_page=10&quot;&gt;; rel=&quot;next`</td>
        </tr>
        <tr>
            <td class="table-content">Last page</td>
            <td class="table-content">`http://api.mangopay.com/v2/ClientId/users/UserId/bank-details?page=1&amp;per_page=10&quot;&gt;; rel=&quot;last`</td>
        </tr>
    </tbody>
</table>