...
Registering a bank account is an action that requires authentication via SCA. In April 2025, Mangopay plans to release a new feature, Recipients, which will replace the legacy Bank Account object. 
