...
import RestCreateibanBankingAlias from '/snippets/code/rest-createiban-banking-alias.mdx';
...
import RubyViewBankingAlias1 from '/snippets/code/ruby-view-banking-alias1.mdx';
