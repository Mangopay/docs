...
api: 'POST /v2.01/{ClientId}/payins/directdebit/web'  
---
...
import NetCreateWebDirectDebitPayin from '/snippets/code/net-create-web-direct-debit-payin.mdx';
