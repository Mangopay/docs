...
The External Instruction Bank Wire PayIn object represents a wire transfer made directly from the end user's bank account to a Virtual Account (or a deprecated Banking Alias).
