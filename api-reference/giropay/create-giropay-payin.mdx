...
import JavaCreateGiropayPayin from '/snippets/code/java-create-giropay-payin.mdx';
import PythonCreateGiropayPayin from '/snippets/code/python-create-giropay-payin.mdx';
import NetCreateGiropayPayin from '/snippets/code/net-create-giropay-payin.mdx';
...
<RequestExample>  
    ...
    <JavaCreateGiropayPayin />
    <PythonCreateGiropayPayin />  
    <NetCreateGiropayPayin />
