---
title: 'Rate limiting'
'og:description': 'Understand the rate limits applied in theapi: learn about the response headers that can help you manage rate limiting, plus best practices for your integration.'
---
...
<table  class="html-table">
  <thead>
    ...
    <tbody>
        <tr>
            <td class="content">15 minutes</td>
            <td class="content">2,300</td>
        </tr>
        <tr>
            <td class="content">30 minutes</td>
            <td class="content">4,500</td>
        </tr>
        <tr>
            <td class="content">1 hour</td>
            <td class="content">8,800</td>
        </tr>
        <tr>
            <td class="content">24 hours</td>
            <td class="content">105,600</td>
        </tr>
    </tbody>
</table>
