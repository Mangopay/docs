...
<UnreachableReasonResponse /></Accordion><Accordion title="200 Bank is unreachable">  

<IsReachableResponse />  

<UnreachableReasonResponse /></Accordion><Accordion title="400 Instant payment disabled "></Accordion></AccordionGroup>  
