...
import NodeViewPayoutCheckModeApplied from '/snippets/code/node-view-payout-check-mode-applied.mdx';
...
This endpoint requires the `payouts_read` scope.
...
<RequestExample>  
    <NodeViewPayoutCheckModeApplied />
</RequestExample>