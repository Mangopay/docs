...
import PaymentRef from '/snippets/p-body/PaymentRef.mdx';
...
import RestCreatePayoutSctInst from '/snippets/code/rest-create-payout-sct-inst.mdx';
import RestCreatePayoutRtgs from '/snippets/code/rest-create-payout-rtgs.mdx';
...
import JavaCreatePayout from '/snippets/code/java-create-payout.mdx';
import PythonCreatePayout from '/snippets/code/python-create-payout.mdx';
import NetCreatePayout from '/snippets/code/net-create-payout.mdx';
...
<RequestExample>  
  <RestCreatePayout/>
  <RestCreatePayoutSctInst/>
  <RestCreatePayoutRtgs/>
