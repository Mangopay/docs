...
<AccordionGroup><Accordion title="200 Standard: Created">  
...
<EndToEndIdResponse /></Accordion><Accordion title="200 Instant payment: Created">  
...
<EndToEndIdResponse /></Accordion><Accordion title="400 Instant payout is deactivated"></Accordion><Accordion title="400 Instant payout is deactivated (INSTANT_PAYOUT_ONLY requested)"></Accordion><Accordion title="400 Destination bank not eligible for instant payout"></Accordion></AccordionGroup>  
