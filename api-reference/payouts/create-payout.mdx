...
import PayoutModeRequested from '/snippets/body-parameters/PayoutModeRequested.mdx';
import BankWireRef from '/snippets/body-parameters/BankWireRef.mdx';
import BankAccountId from '/snippets/body-parameters/BankAccountId.mdx';
import DebitedWalletId from '/snippets/body-parameters/DebitedWalletId.mdx';
import Fees2 from '/snippets/body-parameters/Fees2.mdx';
import DebitedFunds3 from '/snippets/body-parameters/DebitedFunds3.mdx';
import AuthorId1 from '/snippets/body-parameters/AuthorId1.mdx';
...
<Accordion title="400 - Instant payout is deactivated (INSTANT_PAYOUT_ONLY requested)">
<ErrorReport_Message />
<ErrorReport_Type />
<ErrorReport_Id />
<ErrorReport_Date />
...
```json 400 - Instant payout is deactivated  
...
```json 400 - Instant payout is deactivated (INSTANT_PAYOUT_ONLY requested)  
...
```json 400 - Destination bank not eligible for instant payout  
