...
<AccordionGroup><Accordion title="200 - Valid format for the country">  

<CompanyNumber1Response /></Accordion><Accordion title="400 - Country code not recognized"></Accordion></AccordionGroup>  
