...
import SecureMode2 from '/snippets/body-parameters/SecureMode2.mdx';
import ValidationUsage from '/snippets/body-parameters/ValidationUsage.mdx';
...
import PaymentCategory from '/snippets/body-parameters/PaymentCategory.mdx';
