...
### Description
The TWINT PayIn object allows platforms to process payments with TWINT, made by scanning a QR code or entering a verification code to validate the payment.
