...
<Note>
**Note – Max. 100 pay-ins possible against each registration**

A maximum of 100 pay-ins, CIT and MIT included, can be made against each Recurring PayIn Registration. Once you reach this limit, the next pay-in will fail with the error <a href="/errors/codes/205001">205001</a>. 
