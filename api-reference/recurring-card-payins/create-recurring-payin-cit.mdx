...
<AccordionGroup>
<Accordion title="400 - Free cycle declared in registration: debited funds can't be sent">
```json
{
    "Message": "One or several required parameters are missing or incorrect. An incorrect resource ID also raises this kind of error.",
    "Type": "param_error",
    "Id": "6224dcac-cf20-4305-98f0-6ba622090e53",
    "Date": 1760624922.0,
    "errors": {
        "DebitedFunds": "must not be specified for a free cycle."
    }
}
```
</Accordion>
