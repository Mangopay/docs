...
import JavaCreateRecurringPayinMit from '/snippets/code/java-create-recurring-payin-mit.mdx';
import PythonCreateARecurringPayinMit from '/snippets/code/python-create-a-recurring-payin-mit.mdx';
import NetCreateRecurringPayinMit from '/snippets/code/net-create-recurring-payin-mit.mdx';
...
<Accordion title="400 - CIT needed to re-authenticate user">
````json
{
...
<RequestExample>  
    ...
    <JavaCreateRecurringPayinMit />
    <PythonCreateARecurringPayinMit />
    <NetCreateRecurringPayinMit />
</RequestExample>