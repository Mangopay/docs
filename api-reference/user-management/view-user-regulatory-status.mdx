...
import ScopeBlockedResponse from '/snippets/parameters/ScopeBlockedResponse.mdx';
import ActionCodeResponse from '/snippets/parameters/ActionCodeResponse.mdx';
