...
Initiating a transfer may require the user to authenticate using SCA on a Mangopay-hosted webpage, unless Mangopay can apply an exemption (read more about [SCA on transfers](/guides/sca/transfers)).
