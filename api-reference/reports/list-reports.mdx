...
import Array_ReportsResponse from '/snippets/response-parameters/Array_ReportsResponse.mdx';
import AfterDate3 from '/snippets/query-parameters/AfterDate3.mdx';
import BeforeDate3 from '/snippets/query-parameters/BeforeDate3.mdx';
