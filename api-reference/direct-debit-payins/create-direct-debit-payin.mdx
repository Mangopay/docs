...
import RestCreateADirectDebitPayin from '/snippets/code/rest-create-direct-debit-payin.mdx';
import CreateDirectDebitPayinPhp from '/snippets/code/create-direct-debit-payin-php.mdx';
