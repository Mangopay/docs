...
This endpoint requires the `UboDeclarations:read` scope.
...
import NetListUserUboDeclaractions from '/snippets/code/net-list-user-ubo-declarations.mdx';
