---
title: 'Create an Instant Conversion between user Wallets'  
...
import PhpCreateInstantUserConversion from '/snippets/code/php-create-instant-conversion-user-wallets.mdx'
import JavaCreateInstantConversion from '/snippets/code/java-create-instant-conversion.mdx';

This endpoint requires the `conversions_read` scope to be enabled on your client credentials.
...
<RequestExample>  
    ...
    <PhpCreateInstantUserConversion />
