...
import JavaCreateRepudiationWalletDirectBankWirePayIn from '/snippets/code/java-create-repudiation-wallet-direct-bank-wire-payin.mdx';
...
<RequestExample>  
    ...
    <JavaCreateRepudiationWalletDirectBankWirePayIn />
</RequestExample>