...
import JavaCreateBankWirePayInToRepudiationWalletPayIn from '/snippets/code/java-create-bank-wire-payin-to-repudiation-wallet.mdx';
...
<RequestExample>  
    ...
    <JavaCreateBankWirePayInToRepudiationWalletPayIn />
</RequestExample>