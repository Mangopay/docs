...
import RestCreateBankWirePayInToRepudiationWallet from '/snippets/code/rest-create-bank-wire-payin-to-repudiation-wallet.mdx';
import JavaCreateBankWirePayInToRepudiationWallet from '/snippets/code/java-create-bank-wire-payin-to-repudiation-wallet.mdx';
...
<RequestExample>  
    <RestCreateBankWirePayInToRepudiationWallet />  
    <JavaCreateBankWirePayInToRepudiationWallet />
</RequestExample>