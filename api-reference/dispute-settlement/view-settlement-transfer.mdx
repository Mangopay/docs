...
import JavaViewSettlementTransfer from '/snippets/code/java-view-settlement-transfer.mdx';
import ViewSettlementTransferPython from '/snippets/code/view-settlement-transfer-python.mdx';
import NetViewSettlementTransfer from '/snippets/code/net-view-settlement-transfer.mdx';

This endpoint requires the `settlements:read` scope.
...
<RequestExample>  
    ...
    <JavaViewSettlementTransfer />
    <ViewSettlementTransferPython />
    <NetViewSettlementTransfer />
</RequestExample>