...
import JavaCreateSettlementTransfer from '/snippets/code/java-create-settlement-transfer.mdx';
import CreateSettlementTransferPython from '/snippets/code/create-settlement-transfer-python.mdx';
import NetCreateSettlementTransfer from '/snippets/code/net-create-settlement-transfer.mdx';
...
<RequestExample>  
    ...
    <JavaCreateSettlementTransfer />
    <CreateSettlementTransferPython />
    <NetCreateSettlementTransfer />
</RequestExample>