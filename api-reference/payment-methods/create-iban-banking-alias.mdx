...
import Country4 from '/snippets/parameters/Country4.mdx';
import OwnerName1 from '/snippets/parameters/OwnerName1.mdx';
...
```json Wallet already has a Banking Alias  
