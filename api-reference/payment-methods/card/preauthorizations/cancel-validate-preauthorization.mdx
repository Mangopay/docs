...
<CardInfoResponse /></Accordion><Accordion title="400 Cancel attempted after capture"></Accordion><Accordion title="400 Validation attempted before capture"></Accordion></AccordionGroup>  
