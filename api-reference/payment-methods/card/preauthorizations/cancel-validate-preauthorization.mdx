...
import PaymentStatus from '/snippets/body-parameters/PaymentStatus.mdx';
...
<AccordionGroup><Accordion title="200 - Canceled (no captures)">  
...
```json 400 - Cancel attempted after capture  
...
```json 400 - Validation attempted before capture  
