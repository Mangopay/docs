...
<Accordion title="200 - Failed: Amount greater than remaining funds">  
...
</Accordion><Accordion title="400 - Failed: Preauthorization Status not SUCCEEDED">
<ErrorReport_Message />
<ErrorReport_Type />
<ErrorReport_Id />
<ErrorReport_Date />
...
```json 400 - Failed: Preauthorization Status not SUCCEEDED  
