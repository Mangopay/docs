...
<StatementDescriptorResponse /></Accordion><Accordion title="400 Partial capture not possible "></Accordion><Accordion title="400 Attempting to capture a canceled deposit"></Accordion></AccordionGroup>  
