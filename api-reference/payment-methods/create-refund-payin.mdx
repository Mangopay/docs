...
```json Fees parameter must be defined  
...
###### 400 <inline-code>DebitedFunds</inline-code> exceed initial <inline-code>CreditedFunds</inline-code>  

 <ResponseExample>  

```json <inline-code>DebitedFunds</inline-code> exceed initial <inline-code>CreditedFunds</inline-code>  
...
```json The transaction is already disputed  
