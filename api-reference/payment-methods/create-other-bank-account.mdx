...
import Country3 from '/snippets/parameters/Country3.mdx';
...
<Warning>  
**Caution – Additional information may be required** 
  
OTHER-type bank accounts may require additional information depending on the country (e.g., BSB number for payouts to Australia). Please get in touch with our Support team to make sure the correct details are provided.  
</Warning>  
