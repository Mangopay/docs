...
import Culture1 from '/snippets/body-parameters/Culture1.mdx';
import TemplateURLOptions from '/snippets/body-parameters/TemplateURLOptions.mdx';
...
import DirectDebitType from '/snippets/body-parameters/DirectDebitType.mdx';
