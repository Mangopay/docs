...
<StatementDescriptor1Response /></Accordion><Accordion title="400 Payment method not activated"></Accordion><Accordion title="400 Statement descriptor not available for BACS Direct Debit "></Accordion></AccordionGroup>  
