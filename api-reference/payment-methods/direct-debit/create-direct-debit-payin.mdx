...
import StatementDescriptor1Response from '/snippets/response-parameters/StatementDescriptor1Response.mdx';
...
import StatementDescriptor1 from '/snippets/body-parameters/StatementDescriptor1.mdx';
import MandateId from '/snippets/body-parameters/MandateId.mdx';
...
```json 400 - Payment method not activated  
...
```json 400 - Statement descriptor not available for BACS Direct Debit   
