...
import Reference1 from '/snippets/body-parameters/Reference1.mdx';
import ShippingPreference from '/snippets/body-parameters/ShippingPreference.mdx';
import Culture4 from '/snippets/body-parameters/Culture4.mdx';
import LineItems1 from '/snippets/body-parameters/LineItems1.mdx';
import Shipping3 from '/snippets/body-parameters/Shipping3.mdx';
...
import Fees12 from '/snippets/body-parameters/Fees12.mdx';
import DebitedFunds13 from '/snippets/body-parameters/DebitedFunds13.mdx';
...
```json 400 - Shipping required if ShippingPreference is SET_PROVIDED_ADDRESS  
...
```json 400 - DebitedFunds amount must equal LineItems total  
