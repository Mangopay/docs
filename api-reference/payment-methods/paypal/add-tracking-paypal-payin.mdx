...
import NotifyBuyer from '/snippets/body-parameters/NotifyBuyer.mdx';
import Carrier from '/snippets/body-parameters/Carrier.mdx';
import TrackingNumber from '/snippets/body-parameters/TrackingNumber.mdx';
...
<AccordionGroup><Accordion title="200 First tracking number">  
...
<TrackingsResponse /></Accordion><Accordion title="200 Second tracking number">  
