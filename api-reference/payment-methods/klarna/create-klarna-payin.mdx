...
import ReferenceResponse from '/snippets/response-parameters/ReferenceResponse.mdx';
import AdditionalDataResponse from '/snippets/response-parameters/AdditionalDataResponse.mdx';
import PhoneResponse from '/snippets/response-parameters/PhoneResponse.mdx';
import EmailResponse from '/snippets/response-parameters/EmailResponse.mdx';
import CultureResponse from '/snippets/response-parameters/CultureResponse.mdx';
import CountryResponse from '/snippets/response-parameters/CountryResponse.mdx';
import LineItemsResponse from '/snippets/response-parameters/LineItemsResponse.mdx';
import ShippingResponse from '/snippets/response-parameters/ShippingResponse.mdx';
import BillingResponse from '/snippets/response-parameters/BillingResponse.mdx';
...
import FeesResponse from '/snippets/response-parameters/FeesResponse.mdx';
...
import Reference from '/snippets/body-parameters/Reference.mdx';
import AdditionalData from '/snippets/body-parameters/AdditionalData.mdx';
import Phone from '/snippets/body-parameters/Phone.mdx';
import Email from '/snippets/body-parameters/Email.mdx';
import Culture from '/snippets/body-parameters/Culture.mdx';
import Country from '/snippets/body-parameters/Country.mdx';
import LineItems from '/snippets/body-parameters/LineItems.mdx';
import Shipping from '/snippets/body-parameters/Shipping.mdx';
import Billing from '/snippets/body-parameters/Billing.mdx';
...
import Fees from '/snippets/body-parameters/Fees.mdx';
import DebitedFunds1 from '/snippets/body-parameters/DebitedFunds1.mdx';
...
```json 400 - Billing address country doesn't match Country  
...
```json 400 - AdditionalData JSON format error  
