...
import JavaCreateIdealPayin from '/snippets/code/java-create-ideal-payin.mdx';
import PythonCreateIdealPayin from '/snippets/code/python-create-ideal-payin.mdx';
import NetCreateIdealPayin from '/snippets/code/net-create-ideal-payin.mdx';
