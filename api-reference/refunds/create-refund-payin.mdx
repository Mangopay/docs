...
import StatementDescriptor_Refunds from '/snippets/body-parameters/StatementDescriptor_Refunds.mdx';
import StatementDescriptorResponse_Refunds from '/snippets/response-parameters/StatementDescriptorResponse_Refunds.mdx';
