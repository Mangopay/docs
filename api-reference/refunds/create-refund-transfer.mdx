...
import JavaCreateRefundTransfer from '/snippets/code/java-create-refund-transfer.mdx';    
import PythonCreateRefundTransfer from '/snippets/code/python-create-refund-transfer.mdx';    
import NetCreateTransferRefund from '/snippets/code/net-create-transfer-refund.mdx';
...
[Read more about transfer refunds](/guides/refunds#transfer-refunds) **&rarr;**
...
<RequestExample>  
    ...
    <JavaCreateRefundTransfer />
    <PythonCreateRefundTransfer />
    <NetCreateTransferRefund />
