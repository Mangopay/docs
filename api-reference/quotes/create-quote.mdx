...
import PhpCreateQuote from '/snippets/code/php-create-quote.mdx';
import NodeCreateQuote from '/snippets/code/node-create-quote.mdx';
...
<Note>
This endpoint requires the `conversions_read` scope.
</Note>
