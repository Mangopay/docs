...
import Url from '/snippets/body-parameters/Url.mdx';
import EventType from '/snippets/body-parameters/EventType.mdx';
...
```json 400 - Hook already exists for this EventType
