...
import EventType from '/snippets/parameters/EventType.mdx';
...
###### 400 Hook already exists for this <inline-code>EventType</inline-code>  

 <ResponseExample>  

```json Hook already exists for this <inline-code>EventType</inline-code>  
