...
import Array_EventsResponse from '/snippets/response-parameters/Array_EventsResponse.mdx';
import AfterDate from '/snippets/query-parameters/AfterDate.mdx';
import BeforeDate from '/snippets/query-parameters/BeforeDate.mdx';
import EventType from '/snippets/query-parameters/EventType.mdx';
...
<Array_EventsResponse /></Accordion></AccordionGroup>  
