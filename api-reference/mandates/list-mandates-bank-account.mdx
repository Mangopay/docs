...
import Array_MandatesResponse from '/snippets/response-parameters/Array_MandatesResponse.mdx';
import BankAccountId1 from '/snippets/path-parameters/BankAccountId1.mdx';
