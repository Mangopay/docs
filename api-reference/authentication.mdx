...
Use the encoded string, preceded by “Basic” and a space, as your Authorization header (this is Basic Access authentication). Unlike most other calls to the API, this endpoint accepts the `x-www-form-urlencoded` Content-Type.TW please add the old table here  
```json API response
{
...
Use the token, preceded by “Bearer” and a space, as the Authorization header in your requests:TW please add the old table here  
