...
This endpoint requires the `disputes` scope to submit or resubmit a dispute.
...
import JavaSubmitDispute from '/snippets/code/java-submit-dispute.mdx';
import SubmitDisputePython from '/snippets/code/submit-dispute-python.mdx';
import NetSubmitDispute from '/snippets/code/net-submit-dispute.mdx';
