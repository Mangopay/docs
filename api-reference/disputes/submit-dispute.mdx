...
import ContestedFunds from '/snippets/body-parameters/ContestedFunds.mdx';
import DisputeId from '/snippets/path-parameters/DisputeId.mdx';
...
```json 400 - ContestedFunds required  
...
```json 400 - ContestedFunds higher than DisputedFunds  
...
```json 400 - ContestDeadlineDate in the past  
