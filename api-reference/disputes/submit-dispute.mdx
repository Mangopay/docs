...
<RepudiationIdResponse /></Accordion><Accordion title="400 ContestedFunds required"></Accordion><Accordion title="400 ContestedFunds higher than DisputedFunds"></Accordion><Accordion title="400 ContestDeadlineDate in the past"></Accordion></AccordionGroup>  
