...
import NodeCloseDispute from '/snippets/code/node-resubmit-dispute1.mdx';
import RubyCloseDispute from '/snippets/code/ruby-close-dispute.mdx';
import JavaCloseDispute from '/snippets/code/java-close-dispute.mdx';
import CloseDisputePython from '/snippets/code/close-dispute-python.mdx';
import NetCloseDispute from '/snippets/code/net-close-dispute.mdx';

This endpoint requires the `disputes:write` scope.
