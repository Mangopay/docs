...
import JavaViewDispute from '/snippets/code/java-view-dispute.mdx';
import PythonViewDispute from '/snippets/code/view-dispute-python.mdx';
import NetViewDispute from '/snippets/code/net-view-dispute.mdx';
