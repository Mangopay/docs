...
import JavaUpdateDispute from '/snippets/code/java-update-dispute.mdx';
import UpdateADisputePython from '/snippets/code/update-a-dispute-python.mdx';
import NetUpdateDispute from '/snippets/code/net-update-dispute.mdx';

This endpoint requires the `disputes_write` scope.
