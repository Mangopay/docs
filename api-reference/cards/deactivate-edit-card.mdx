...
import CardHolderName1 from '/snippets/body-parameters/CardHolderName1.mdx';
import CardHolderNameResponse from '/snippets/response-parameters/CardHolderNameResponse.mdx';
