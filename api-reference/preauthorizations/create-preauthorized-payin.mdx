...
import PhpCreatePreauthorizedPayin from '/snippets/code/php-create-preauthorized-payin.mdx';
...
import JavaCreatePreauthorizedPayin from '/snippets/code/java-create-preauthorized-payin.mdx';
import PythonCreatePreauthorizedPayin from '/snippets/code/python-create-preauthorized-payin.mdx';
import NetCreatePreauthorizedPayin from '/snippets/code/net-create-preauthorized-payin.mdx';
