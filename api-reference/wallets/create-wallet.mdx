...
<CreationDate1Response /></Accordion><Accordion title="400 Limited to one owner per wallet"></Accordion><Accordion title="400 Currency not supported"></Accordion></AccordionGroup>  
