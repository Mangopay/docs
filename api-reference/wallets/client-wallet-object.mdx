...
-Fees Wallet - Stores all `Fees` taken on transactions. The `FundsType` of the Fees Wallet is `FEES`.  
-Repudiation Wallet - Manages funds relating to dispute management. The `FundsType` of the Repudiation Wallet is `CREDIT`.  
