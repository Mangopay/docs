...
import RubyCreateLegalUserSca from '/snippets/code/ruby-create-legal-user-sca.mdx';
import NetCreateLegalUserSca from '/snippets/code/net-create-legal-user-sca.mdx';
import PhpCreateLegalUserSca from '/snippets/code/php-create-legal-user-sca.mdx';
...
<RubyCreateLegalUserSca/>
<NetCreateLegalUserSca/>
<PhpCreateLegalUserSca/>
</RequestExample>