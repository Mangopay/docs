...
import NetCreateNaturalUserSca from '/snippets/code/net-create-natural-user-sca.mdx';
import PhpCreateNaturalUserSca from '/snippets/code/php-create-natural-user-sca.mdx';
...
<RequestExample>  
    ...
    <NetCreateNaturalUserSca/>
    <PhpCreateNaturalUserSca/>
</RequestExample>