...
import NetCategorizeNaturalUser from '/snippets/code/net-categorize-natural-user.mdx';
import RubyCategorizeNaturalUser from '/snippets/code/ruby-categorize-natural-user.mdx';
import PhpCategorizeNaturalUser from '/snippets/code/php-categorize-natural-user.mdx';
...
<RequestExample>  
    ...
    <NetCategorizeNaturalUser />
    <RubyCategorizeNaturalUser />
    <PhpCategorizeNaturalUser />
</RequestExample>