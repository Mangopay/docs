...
description: 'Retrieve a Natural or Legal User'
---
...
import NodeViewUserSca from '/snippets/code/node-get-user-sca.mdx';
import RubyViewUserSca from '/snippets/code/ruby-get-user-sca.mdx';
import NetViewUserSca from '/snippets/code/net-view-user-sca.mdx';
import PhpViewUserSca from '/snippets/code/php-view-user-sca.mdx';
...
[Read more](/guides/sca/users#view-and-list-users) **&rarr;**
