...
import RubyCloseNaturalUser from '/snippets/code/ruby-close-natural-user.mdx';
import NetCloseNaturalUser from '/snippets/code/net-close-natural-user.mdx';
