...
import RubyUpdateLegalUserSca from '/snippets/code/ruby-update-legal-user-sca.mdx';
import NetUpdateLegalUserSca from '/snippets/code/net-update-legal-user-sca.mdx';
import PhpUpdateLegalUserSca from '/snippets/code/php-update-legal-user-sca.mdx';
...
<RequestExample>  
    ...
    <RubyUpdateLegalUserSca />
    <NetUpdateLegalUserSca />
    <PhpUpdateLegalUserSca />
</RequestExample>