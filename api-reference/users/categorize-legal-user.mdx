...
import NetCategorizeLegalUser from '/snippets/code/net-categorize-legal-user.mdx';
import RubyCategorizeLegalUser from '/snippets/code/ruby-categorize-legal-user.mdx';
import PhpCategorizeLegalUser from '/snippets/code/php-categorize-legal-user.mdx';
...
<RequestExample>  
    ...
    <NetCategorizeLegalUser />
    <RubyCategorizeLegalUser />
    <PhpCategorizeLegalUser />
</RequestExample>