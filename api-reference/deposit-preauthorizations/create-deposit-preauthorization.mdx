...
import DebitedFunds12Response from '/snippets/response-parameters/DebitedFunds12Response.mdx';
...
import DebitedFunds10 from '/snippets/body-parameters/DebitedFunds10.mdx';
