---
title: 'List Deposit Preathorizations for a Card Fingerprint'  
api: 'GET /v2.01/{ClientId}/cards/fingerprints/{Fingerprint}/deposit-preauthorizations'  
---

import Array_depositpreauthorizationsResponse from '/snippets/response-parameters/Array_depositpreauthorizationsResponse.mdx';
import PaymentStatus from '/snippets/query-parameters/PaymentStatus.mdx';
