...
import PaymentType_Response_GooglePay from '/snippets/p-response/PaymentType_Response_GooglePay.mdx';
...
import JavaCreateGooglePayPayin from '/snippets/code/java-create-google-pay-payin.mdx';
import PythonCreateGooglePayPayin from '/snippets/code/python-create-google-pay-payin.mdx';
import NetCreateGooglePayPayin from '/snippets/code/net-create-google-pay-payin.mdx';
...
<PaymentType_Response_GooglePay />  
...
<RequestExample>  
    ...
    <JavaCreateGooglePayPayin />
    <PythonCreateGooglePayPayin />
    <NetCreateGooglePayPayin />
</RequestExample>