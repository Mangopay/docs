...
import ExternalData_Capture from '/snippets/p-response/ExternalData_Capture.mdx.mdx';
import Buyer_Intent from '/snippets/p-response/Buyer_Intent.mdx';
import LineItems_Intent_Actions from '/snippets/p-response/LineItems_Intent_Actions.mdx.mdx';
