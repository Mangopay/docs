...
import CreateKlarnaPayinNet from '/snippets/code/net-create-klarna-payin.mdx';
...
The Klarna payment session lasts 3 hours, at which point the pay-in fails automatically if no action has been taken by the user.  
</Note>  
