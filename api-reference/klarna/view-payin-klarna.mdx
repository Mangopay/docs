...
import ViewPayinPhp from '/snippets/code/php-view-payin.mdx';
import ViewPayinNode from '/snippets/code/view-payin-node.mdx';
import ViewPayinRuby from '/snippets/code/view-payin-ruby.mdx';
...
import ViewKlarnaPayinNet from '/snippets/code/net-view-klarna-payin.mdx';
...
<Accordion title="200 - Parameters">  
...
<Accordion title="200 - Result codes">
