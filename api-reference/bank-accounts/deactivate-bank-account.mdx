...
import NetDeactivateBankAccount from '/snippets/code/net-deactivate-bank-account.mdx';

### Scope

This endpoint requires the `bankaccounts_write` scope.
