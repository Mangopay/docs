...
Due to anti-money laundering policy, Mangopay doesn’t accept the creation of bank accounts domiciled in some countries (see the Country restrictions article).  
</Note>  
