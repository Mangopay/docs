...
import Tag4Response from '/snippets/response-parameters/Tag4Response.mdx';
...
import AccountNumberResponse from '/snippets/response-parameters/AccountNumberResponse.mdx';
import OwnerAddressResponse from '/snippets/response-parameters/OwnerAddressResponse.mdx';
import Tag4 from '/snippets/body-parameters/Tag4.mdx';
import OwnerName from '/snippets/body-parameters/OwnerName.mdx';
import BankName from '/snippets/body-parameters/BankName.mdx';
import BranchCode from '/snippets/body-parameters/BranchCode.mdx';
import InstitutionNumber from '/snippets/body-parameters/InstitutionNumber.mdx';
import AccountNumber from '/snippets/body-parameters/AccountNumber.mdx';
import OwnerAddress from '/snippets/body-parameters/OwnerAddress.mdx';
import UserId1 from '/snippets/path-parameters/UserId1.mdx';
