...
<ActiveResponse /></Accordion><Accordion title="400 - Blocked bank account"></Accordion><Accordion title="400 - AccountNumber format not accepted"></Accordion><Accordion title="400 - SortCode format not accepted"></Accordion><Accordion title="400 - SortCode invalid"></Accordion><Accordion title="400 - AccountNumber and SortCode combination not valid"></Accordion></AccordionGroup>  
