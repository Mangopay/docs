...
import AccountNumber1Response from '/snippets/response-parameters/AccountNumber1Response.mdx';
...
import SortCode from '/snippets/body-parameters/SortCode.mdx';
import AccountNumber1 from '/snippets/body-parameters/AccountNumber1.mdx';
...
```json 400 - AccountNumber format not accepted  
...
```json 400 - SortCode format not accepted  
...
```json 400 - AccountNumber and SortCode combination not valid  
