...
import Array_BankAccountsResponse from '/snippets/response-parameters/Array_BankAccountsResponse.mdx';
import UserId1 from '/snippets/path-parameters/UserId1.mdx';
import Active from '/snippets/query-parameters/Active.mdx';
