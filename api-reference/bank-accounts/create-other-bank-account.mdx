...
Requires the **`bank_accounts_write`** scope.
...
import AccountNumber4Response from '/snippets/p-response/AccountNumber4Response.mdx';
...
import AccountNumber4 from '/snippets/p-body/AccountNumber4.mdx';
...
import NetCreateOtherBankAccount from '/snippets/code/net-create-other-bank-account.mdx'; 
