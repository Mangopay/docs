...
import JavaListBankAccountTransactions from '/snippets/code/java-list-bank-account-transactions.mdx';
import PythonListBankAccountTransactions from '/snippets/code/python-list-bank-account-transactions.mdx';
import NetListBankAccountTransactions from '/snippets/code/net-list-bank-account-transactions.mdx';
...
<AccordionGroup>
<Accordion title="200 - Payouts-only example">  
...
<RequestExample>  
    ...
    <JavaListBankAccountTransactions />
    <PythonListBankAccountTransactions />
    <NetListBankAccountTransactions />
</RequestExample>