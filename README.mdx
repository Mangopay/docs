...
GitHub Desktop gives an easy-to-use experience for GitHub and your chosen IDE (VSC recommended).

2. Install Node.js and npm (use nvm as [recommended here](https://docs.npmjs.com/downloading-and-installing-node-js-and-npm))

On mac you can install homebrew via Mangopay Self-Service and then use that to install nvm: 
```
brew install nvm
```
...
npm i -g mint
```
Mintlify installer is also available in Mangopay Self-Service.
