...
<CardGroup cols={2}>
  <Card title="Users" icon="square-1" href="api-reference/users/">
    When it comes to payments compliance, your community is our responsibility.
  </Card>
  <Card title="Wallets" icon="square-2" href="api-reference/wallets">
    Mangopay's wallets hold the funds processed on behalf of platforms and their users.
  </Card>
  <Card title="Payment Methods" icon="square-3" href="api-reference/payment-methods">
    The payments your users expect. The flexibility your business needs.
  </Card>
  <Card title="Conversions" icon="square-4" href="api-reference/conversions">
...
Explore our deveoper tools.

<CardGroup cols={3}>
  <Card title="Hub" icon="square-1" href="https://hub.mangopay.com/">
    Sign up to the Mangopay Hub to get a Sandbox API key for free.
  </Card>
  <Card title="API Reference" icon="square-2" href="api-reference/introduction">
    Find everything you need to know about how the Mangopay API works.
  </Card>
  <Card title="Notifications" icon="square-3" href="development-resources/notifications">
