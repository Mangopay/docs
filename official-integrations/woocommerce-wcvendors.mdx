...
**2/ Set up the relevant settings** in the plugin Settings view (available by selecting WC Vendors and then Settings in the left menu).TW please add the old table here  
...
**2/ Set up the relevant settings **in the plugin Settings view (accessible by selecting WooCommerce and then Settings in the left menu).TW please add the old table here  
