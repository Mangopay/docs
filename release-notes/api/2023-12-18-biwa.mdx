...
<div class="release-notes-page">
  ...
  * <a href="/api-reference/deposit-preauthorizations/cancel-deposit-preauthorization">PUT Cancel a Deposit Preauthorization or request a no-show</a>
  ...
  * DEPOSIT\_PREAUTHORIZATION\_PAYMENT\_FAILED
  ...
  <Card title="How to" href="/guides/payment-methods/card/deposit-preauthorization">How to process a 30-day preauthorization</Card>
</div>
