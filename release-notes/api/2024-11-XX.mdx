...
Platforms can now provide information about the initial pay-in on payouts that are being used to reimburse them. This is possible thanks to the new `PaymentRef` parameter on the [Payout](/api-reference/payouts/payout-object) object.
