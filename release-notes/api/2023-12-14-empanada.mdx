...
<Card title="Guide" href="/guides/payment-methods/card/card-validation">Read more about the card validation feature</Card>  

<Card title="How to" href="/guides/payment-methods/card/card-validation/how-to">How to validate a card without debiting a payment</Card>