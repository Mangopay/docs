...
For more information, see the updated <a href="/api-reference/card-validations/create-card-validation">Create a Card Validation endpoint</a> and <a href="http://localhost:3000/guides/payment-methods/card/validation">Card Validation guide</a>.