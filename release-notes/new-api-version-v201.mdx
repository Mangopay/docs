...
In each case, the previous string format is no longer accepted, and a more detailed array of information is required. Further information is available below:TW please add the old table here  
