---
title: 'API Release New API version v2.01'  
---
...
<table class="html-table">
    ...
    <tbody>
        <tr>
            <td class="content">`AddressLine1`</td>
            <td class="content">String</td>
            <td class="content"></td>
        </tr>
        <tr>
            <td class="content">`AddressLine2`</td>
            <td class="content">String</td>
            <td class="content">This is optional</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="content">String</td>
            <td class="content">Optional unless Country is "MX", "CA" or "US"</td>
        </tr>
        <tr>
            <td class="content">`PostalCode`</td>
            <td class="content">String</td>
            <td class="content">Must be be alphanumeric (or spaces) – not required if the Country is one of "AO", "AG", "AW", "BS", "BZ", "BJ", "BW", "BF", "BI", "CM", "CF", "KM", "CG", "CD", "CK", "CI", "DJ", "DM", "GQ", "ER", "FJ", "TF", "GM", "GH", "GD", "GN", "GY", "HK", "IE", "JM", "KE", "KI", "MO", "MW", "ML", "MR", "MU", "MS", "NR", "AN", "NU", "KP", "PA", "QA", "RW", "KN", "LC", "ST", "SA", "SC", "SL", "SB", "SO", "ZA", "SR", "SY", "TZ", "TL", "TK", "TO", "TT", "TV", "UG", "AE", "VU", "YE", "ZW "</td>
        </tr>
        <tr>
            <td class="content">`Country`</td>
            <td class="content">String</td>
            <td class="content">Must be an ISO 3166-1 alpha-2 code</td>
        </tr>
    </tbody>
</table>
