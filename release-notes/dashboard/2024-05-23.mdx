...
Dashboard users can now securely upload documents to our teams directly from the Dashboard, instead of using email. This enables platforms to securely transfer files when requested by Mangopay team members, for example during the platform’s onboarding process.
