...
<th class="header">Description</th>
<td class="table-content">
The Owner User (Natural or Legal Soletrader) has triggered SCA enrollment or re-enrollment via a User endpoint. Their access to SCA-controlled actions is restricted until they complete the SCA redirection to enroll successfully.
<br/><br/>
