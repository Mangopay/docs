...
<Card title="USER_ACCOUNT_VALIDATION_ASKED">
**RessourceId:** UserId
...
<Card title="USER_ACCOUNT_ACTIVATED">
**RessourceId:** UserId
...
<Card title="PAYIN_NORMAL_PROCESSING_STATUS_PENDING_SUCCEEDED">  
**RessourceId:** PayInId   
...
<table>
<tbody>
<tr><th class="header">Event type</th><td>`PAYIN_NORMAL_PROCESSING_STATUS_PENDING_SUCCEEDED`</td></tr>
<tr><th class="header">`RessourceId`</th><td>`PayInId` (`Id` of the pay-in)</td></tr>
<tr><th class="header">Relevant GET endpoint</th><td>[GET View a PayIn (Pay by Bank)](/api-reference/pay-by-bank/view-payin-pay-by-bank)</td></tr>
<tr><th class="header">Description</th><td>The Pay by Bank PayIn has been successfully initiated by the user. The funds have not yet arrived on Mangopay’s bank account and the pay-in Status is still `CREATED`.</td></tr>
</tbody>
</table>

| Hook `EventType` | **`PAYIN_NORMAL_PROCESSING_STATUS_PENDING_SUCCEEDED`** |
| **`RessourceId`** | `PayInId` (`Id` of the pay-in) |
| **Relevant GET endpoint** | GET View a PayIn |
| **Description** | The Pay by Bank PayIn has been successfully initiated by the user. The funds have not yet arrived on Mangopay’s bank account and the pay-in Status is still `CREATED`. |
