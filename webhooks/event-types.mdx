...
To listen to an event type on your chosen URL, set up a webhook <a href="https://hub.mangopay.com/" target="_blank">Mangopay Dashboard</a> (***Developers*** > ***Webhooks***) or using the [POST Create a Hook](/api-reference/webhooks/create-hook) endpoint.
...
<tr>
<th class="header">Resource and GET</th>
<td class="table-content">`UserId` [GET View a User's regulatory status](/api-reference/user-regulatory-status/view-user-regulatory-status)</td>
</tr>
</table>
...
<td class="table-content">`UserId` (`Id` of the User)</td>
</tr>
<tr>
<th class="header">Related&rarr;GET</th>
<td class="table-content">[GET View a User's regulatory status](/api-reference/user-regulatory-status/view-user-regulatory-status)</td>
</tr>
</table>
