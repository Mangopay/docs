...
The User has been blocked by Mangopay and can no longer make pay-ins or send transfers.
</Card>  
  
<Card title="USER_INFLOWS_UNBLOCKED">  
**RessourceId :** UserId   
  
The User has been unblocked by Mangopay and can now make pay-ins or send transfers.  
</Card>  

<Card title="USER_OUTFLOWS_BLOCKED">  
**RessourceId :** UserId   
  
The User has been blocked by Mangopay and can no longer make payouts or send transfers.  
</Card>  
  
<Card title="USER_OUTFLOWS_UNBLOCKED">  
**RessourceId :** UserId   
  
The User has been unblocked by Mangopay and can now make payouts or send transfers.  
</Card>
