...
All our T&Cs are on our website <a href="https://mangopay.com/terms-and-conditions/payment-services">Terms and conditions</a> page.
...
For more information about the requirements for T&Cs and best practices in handling them, see the [dedicated guide](/guides/users/terms).
...
If the user disagrees with Mangopay’s updated T&Cs, the user is required to remove any funds from wallets they hold before proceeding with the closure of their Mangopay Account. Once their wallets are empty, please contact our Support team <a href="mailto:end-users@mangopay.com">by email</a> or <a href="https://hub.mangopay.com" target="_blank">via the Dashboard</a> to initiate the account closure.
...
Please send an email to the address provided by Mangopay in their communication with you. In your reply, kindly confirm that you've accurately informed your users about the updated T&Cs.
