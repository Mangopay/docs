...
Some features are not handled by the Mangopay WooCommerce/WC Vendors plugin and should be done in the <MangopayDashboard content="Mangopay Dashboard" /> (available through the Mangopay Dashboard).  
...
<a href="https://hub.mangopay.com/" target="_blank" class="btn normal">Contact Support from the Dashboard &rarr;</a>