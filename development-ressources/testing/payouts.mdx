...
To test payouts, you need to create a valid <a href="">Bank Account</a> and make a <a href="">Payout to it</a>. You can use these test accounts:   
...
You can then use the <a href="">Sandbox operations</a> view of the Dashboard to process the payout.  
...
<Card title="Endpoints">Payouts - Endpoints</Card>  

<Card title="Tutorial">How to process an Instant Payout</Card>  

<Card title="Article">Payouts - Core concepts</Card>