...
---  
                    ...
                    | **Error message**     | The Status of this Mandate does not allow for payments                   |
                    |-----------------------|--------------------------------------------|
                    | **Short description** | The pay-in failed due to the status of the corresponding mandate. |
