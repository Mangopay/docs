...
---  
                    ...
                    | **Error message**     | User has not been redirected then the payment session has expired                   |
                    |-----------------------|--------------------------------------------|
                    | **Short description** | The pay-in failed because the user wasn’t redirected to the payment page. |
