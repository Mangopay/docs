...
---  
                    ...
                    | **Error message**     | PayPal account's owner has not approved payment                   |
                    |-----------------------|--------------------------------------------|
                    | **Short description** | The pay-in failed because the PayPal account owner rejected the payment. |
