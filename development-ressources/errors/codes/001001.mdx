...
---  
                    ...
                    | **Error message**     | Unsufficient wallet balance                   |
                    |-----------------------|--------------------------------------------|
                    | **Short description** | The wallet does not contain enough funds to process the transaction. |
                    | **Categories**        | <div class="label">Transfer</div><div class="label">Wallet</div><div class="label">Payout</div><div class="label">Refund</div>                         |
