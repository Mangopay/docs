...
---  
                    ...
                    |-----------------------|--------------------------------------------|
                    | **Short description** | The pay-in is blocked due to too many attempts for the same transaction. |
                    | **Categories**        | <div class="label">Refused transaction</div><div class="label">Pay-in</div>                         |
