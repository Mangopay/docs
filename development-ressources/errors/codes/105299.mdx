...
---  
                    ...
                    | **Error message**     | Token input Error                   |
                    |-----------------------|--------------------------------------------|
                    | **Short description** | An error occurred when submitting the token to the bank. |
                    | **Categories**        | <div class="label">Card registration</div><div class="label">Card tokenization</div>                         |
