...
---  
                    ...
                    | **Error message**     | The banking alias is not active                   |
                    |-----------------------|--------------------------------------------|
                    | **Short description** | The pay-in to the ibanized wallet failed because the Banking Alias is not active. |
                    | **Categories**        | <div class="label">Bank wire pay-in</div><div class="label">Refused transaction</div>                         |
