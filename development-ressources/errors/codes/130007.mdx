...
---  
                    ...
                    | **Error message**     | Destination Bank is not reachable                   |
                    |-----------------------|--------------------------------------------|
                    | **Short description** | The bank to which the payout is made is not reachable. |
...
You can check if the bank is reachable beforehand by using the dedicated Check Instant Payout eligibility endpoint.  
