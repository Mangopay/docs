...
---  
                    ...
                    | **Error message**     | Conversion could not be debited from wallet                   |
                    |-----------------------|--------------------------------------------|
                    | **Short description** | The funds could not be withdrawn from the debited wallet. |
                    | **Categories**        | <div class="label">FX</div>                         |
