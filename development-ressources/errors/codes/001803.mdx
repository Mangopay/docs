...
---  
                    ...
                    | **Error message**     | Direct debit is not enabled for this bank account                   |
                    |-----------------------|--------------------------------------------|
                    | **Short description** | The mandate cannot be created because direct debit is not supported for this bank account. |
