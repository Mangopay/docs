...
---  
                    ...
                    |-----------------------|--------------------------------------------|
                    | **Short description** | The card has reached the amount limit set by the issuing bank. |
                    | **Categories**        | <div class="label">Refused transaction</div><div class="label">Card</div>                         |
