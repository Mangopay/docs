...
---  
                    ...
                    | **Error message**     | The user has disputed the payment                   |
                    |-----------------------|--------------------------------------------|
                    | **Short description** | The user requested a chargeback for this payment. |
                    | **Categories**        | <div class="label">Mandate</div><div class="label">Direct debit</div><div class="label">Dispute</div>                         |
