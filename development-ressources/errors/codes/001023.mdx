...
---  
                    ...
                    |-----------------------|--------------------------------------------|
                    | **Short description** | The pay-in failed because the author is different from the card owner. |
                    | **Categories**        | <div class="label">Pay-in</div><div class="label">Preauthorization</div>                         |
