...
---  
                    ...
                    | **Error message**     | Invalid PaymentData                   |
                    |-----------------------|--------------------------------------------|
                    | **Short description** | The PaymentData provided for the Google Pay pay-in is not valid |
                    | **Categories**        | <div class="label">Pay-in</div><div class="label">Google Pay</div>                         |
