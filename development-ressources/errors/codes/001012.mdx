...
---  
                    ...
                    | **Error message**     | Transaction amount is lower than minimum permitted amount                   |
                    |-----------------------|--------------------------------------------|
                    | **Short description** | The transaction cannot be performed because the amount is lower than the minimum permitted amount. |
                    | **Categories**        | <div class="label">Payout</div><div class="label">Wallet</div><div class="label">Pay-in</div>                         |
