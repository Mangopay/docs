...
---  
                    ...
                    | **Error message**     | Due to repudiations against this transaction, you can not refund this amount.                   |
                    |-----------------------|--------------------------------------------|
                    | **Short description** | The refund failed because the pay-in is already being disputed. |
                    | **Categories**        | <div class="label">Refund</div><div class="label">Dispute</div>                         |
