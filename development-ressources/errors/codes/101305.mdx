...
---  
                    ...
                    | **Error message**     | SecureMode: Soft decline                   |
                    |-----------------------|--------------------------------------------|
                    | **Short description** | Strong customer authentication is required in order to be able to proceed to the payment due to soft decline. |
