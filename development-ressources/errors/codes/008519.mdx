...
---  
                    ...
                    | **Error message**     | Transaction refused due to blocked OTHER account                   |
                    |-----------------------|--------------------------------------------|
                    | **Short description** | The payout cannot be performed because the target OTHER bank account is blocked. |
