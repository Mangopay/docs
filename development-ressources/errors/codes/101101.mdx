...
---  
                    ...
                    | **Error message**     | Transaction refused by the bank (Do not honor)                   |
                    |-----------------------|--------------------------------------------|
                    | **Short description** | The transaction has been refused due to restrictions on the issuing bank side. |
